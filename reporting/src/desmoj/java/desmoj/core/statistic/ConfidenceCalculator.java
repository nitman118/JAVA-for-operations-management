 ...
 * the mean of the samples passed to the <code>ConfidenceCalculator</code>.
...
public class ConfidenceCalculator extends Tally {
	 ...
	 * 
	 * @return desmoj.report.Reporter : The Reporter for this
	 *         ConfidenceCalculator.
	 */
	 ...
	 * 
	 * Note: The confidence interval computation assumes that the input values
	 * are (approximately) identically and independently distributed.
	 * 
	 * @param level
