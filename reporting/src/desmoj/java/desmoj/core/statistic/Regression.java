...
public class Regression extends desmoj.core.statistic.StatisticObject {
	 ...
	 * The names will be set to "X" and "Y".
	 */
	 ...
	 * 
	 * @param ownerModel
	 *            Model : The model this Regression object is associated to
	 * @param name
	 *            java.lang.String : The name of this Regression object
	 * @param xName
	 *            java.lang.String : The name for the x values.
	 * @param yName
	 *            java.lang.String : The name for the y values.
	 * @param xValsup
	 *            ValueSupplier : The ValueSupplier providing the x values for
	 *            the regression analysis. The given ValueSupplier will be
	 *            observed by this Regression object.
	 * @param yValsup
	 *            ValueSupplier : The ValueSupplier providing the y values for
	 *            the regression analysis. The given ValueSupplier will be
	 *            observed by this Regression object.
	 * @param showInReport
	 *            boolean : Flag for showing the report about this Regression.
	 * @param showInTrace
	...
	/**
	 * Returns the actual value of the <code>ValueSupplier</code> supplying
	 * the x-value.
	 * 
	...
	/**
	 * Updates this <code>Regression</code> object by fetching the actual
	 * values of the <code>ValueSupplier</code> s and processing them. The
	...
	/**
	 * Updates this <code>Regression</code> object with the x and y double
	 * values given as parameters. In some cases it might be more convenient to
	 * pass the values this <code>Regression</code> will be updated with
	 * directly within the <code>update(double xVal, double yVal)</code>
	 * method instead of going via the <code>ValueSupplier</code>.
	 * 
	 * @param xVal
	 *            double : The x value with which this <code>Regression</code>
	 *            will be updated.
	 * @param yVal
	 *            double : The y value with which this <code>Regression</code>
	 *            will be updated.
	 */
	 ...
	 * Whenever either of the two <code>ValueSupplier</code> objects providing
	 * the x or y value is updated and calling <code>notifyStatistics()</code>
	 ...
	 * @param arg
	 *            Object : The Object with which this <code>Regression</code>
	 *            is updated.
	 */
	 ...
	 * 
	 * @return boolean :<code>true</code> is returned if no considerable
	 *         change of the x-values can be recognized. <code>false</code>
	 *         otherwise.
	 */
	 ...
	 * 
	 * @return boolean :<code>true</code> is returned if no considerable
	 *         change of the y-values can be recognized. <code>false</code>
	 *         otherwise.
	 */
