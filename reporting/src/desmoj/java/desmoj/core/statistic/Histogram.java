 ...
 * the end the report will show how many values belong to which section. <br />
 *
 * @version DESMO-J, Ver. 2.4.2 copyright (c) 2014
 * @author Soenke Claassen
 * @author based on DESMO-C from Thomas Schniewind, 1998
 * @author edited by Lorna Slawski (changes in implementation and added possibility of non-equidistant sections as well as the Chi-squared test)
 *
...
public class Histogram extends desmoj.core.statistic.Tally {
   ...
   *            java.lang.String : The name of this Histogram object.
   * @param range
   *            double[] : The interval with the lower limit of each cell and the upper limit of the interval as the final value.
   * @param showInReport
   *            boolean : Flag for showing the report about this Histogram.
   * @param showInTrace
   *            boolean : Flag for showing the trace output of this Histogram.
   ...
   *
   * @return boolean : Not displaying unused cells in report view (<code>true</code>) or 
   *          printing all cells (<code>false</code>).
   */
   ...
   *
   * @param condensed 
   *            boolean:  Not displaying unused cells in report view (<code>true</code>) or 
   *          printing all cells (<code>false</code>).
   */
   ...
   *
   * @param range
   *            double[] : The array holding the lower limits of the interval sections and the upper limit as the final value.
   */
   ...
   * The frequencies are given in an array either including under- and overflow cells or not. The degree of freedom is
   * set to 1 deducted from the number of given cells.
   * On an error the Chi-squared test is not performed and false is returned.
   * Details on errors are given out in the error message log.
   * The result is <code>true</code> if the null hypothesis can not be rejected.
   *
   * @param values
   ...
   */
  @Deprecated public int getMostFrequentedCell() {
   ...
   * interval and the number of sections this interval is divided into will
