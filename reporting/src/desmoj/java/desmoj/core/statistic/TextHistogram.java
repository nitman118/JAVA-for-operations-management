 ...
 * every given text.
 * If the given parameter is a null pointer it will not be counted.
 *
...
desmoj.core.simulator.Reportable implements java.util.Observer {
	 ...
	 *
	 * @param ownerModel
	 *            Model : The model this TextHistogram is associated to.
	 * @param name
	 *            java.lang.String : The name of this TextHistogram object.
	 * @param showInReport
	 ...
	 *            this TextHistogram object.
	 * @param showInReport
	 *            boolean : Flag for showing the report about this TextHistogram.
	 * @param showInTrace
	 *            boolean : Flag for showing the trace output of this TextHistogram.
	 */
	...
	/**
	 * Returns the String with the least number of entries. Several Strings are separated by a comma.
	 * If there are no entries yet an empty String ("") is being returned.
	 *
	...
	/**
	 * Returns the String with the largest number of entries. Several Strings are separated by a comma.
	 * If there are no entries yet an empty String ("") is being returned.
	 *
	 ...
	 *
	 * @return TextSupplier : The TextSupplier object providing the Strings for
	 *         this TextHistogram.
	 */
	...
	/**
	 * Updates this <code>TextHistogram</code> object by fetching the actual
	 * value of the <code>TextSupplier</code> and processing it.
	 * If the actual value is a <code>null</code> pointer it will not be counted and an
	 * error is given out in the error report.
	 * The <code>TextSupplier</code> is passed in the constructor of this
	...
	public void update() {
		...
		if(this._lastString == null) {
			...
			if (this._map.containsKey(this._lastString)) {
				...
				this._map.put(this._lastString.toString(), 1L);
			}
	...
	/**
	 * Updates this <code>TextHistogram</code> object with the String value
	 * given as parameter.
	 * If the parameter is a <code>null</code> pointer it will not be counted and an
	 * error is given out in the error report.
	 * In some cases it might be more convenient to pass the String value this <code>TextHistogram</code> will be updated with directly
	 * within the <code>update(String updateStr)</code> method instead of going via
	 * the <code>TextSupplier</code>.
	 *
	 * @param updateStr
	 *            String : The String with which this <code>TextHistogram</code>
	 *            will be updated.
	 */
	 ...
	 * value of the TextSupplier will be fetched with the <code>text()</code>
	 * method of the TextSupplier. Otherwise it is expected that the actual
	 * text is passed in the Object arg.
	 * If the the actual value is a <code>null</code> pointer it will not be counted and an
	 * error is given out in the error report.
	 *
	 * @param o
	 ...
	 *            which is added to the statistics or <code>null</code> when
	 *            there is an actual text to be given with the <code>text()</code>
	 *            method.
	 */
