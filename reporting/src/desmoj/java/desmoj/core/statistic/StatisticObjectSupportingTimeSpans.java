 ...
 * specific data collector classes able to handle <code>TimeSpan</code> objects.
...
public abstract class StatisticObjectSupportingTimeSpans extends StatisticObject
    ...
    * 
     * @param t
     *            TimeSpan : The time span to update this data collector.
     */
     ...
     * Unless a unit is explicitly otherwise using <code>setUnit(...)</code>,
     * this class assumes updates refer to the reference time unit.
     * 
     * @param value
