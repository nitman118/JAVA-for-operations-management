...
/**
 * Provides the class for user defined events to change <b>three</b> entities'
 * internal states. The state of a discrete model is changed by events that occur
 * at distinct points of simulation time.<p>
 * For events changing the state of <b>one</b> or <b>two</b> entities,
 * refer to <code>Event</code> and <code>EventOf2Entities</code>.
...
public abstract class EventOf3Entities<E extends Entity, F extends Entity, G extends Entity> extends EventAbstract {
     ...
     * does to three entities (as <code>SimProcess</code> is a subclass of 
     * <code>Entity</code>, processes can be passed as well).
     * <p>
     * For type safety, it is recommended to derive your events from the generic
     * type <code>EventOf3Entities&lt;EntityType1,EntityType2,EntityType3&gt;</code> where
     * <code>EntityType1</code>, <code>EntityType2</code> and <code>EntityType3</code> 
     * (which are derived from class <code>Entity</code>) represent the entity types 
     * your event is supposed to operate on.
     * <p>
     ...
     * 
     * @param who1
     *            E : The first entity associated to this event.
     * @param who2
     *            F : The second entity associated to this event.
     * @param who3
     *            G : The second entity associated to this event.
     */
	...
	public void schedule(E who1, F who2, G who3, TimeInstant instant) {
        ...
        // schedule Event
		getModel().getExperiment().getScheduler().schedule(who1, who2, who3, this, instant);
	 ...
	 * 
	 * @param who1
	 *            E : The first entity this event happens to
	 * @param who2
	 *            F : The second entity this event happens to
	 * @param who3
	 *            G : The third entity this event happens to
	 * @param dt
	...
	public void schedule(E who1, F who2, G who3, TimeSpan dt) {
        ...
        // schedule Event
		getModel().getExperiment().getScheduler().schedule(who1, who2, who3, this, dt);
    ...
    public void schedule(E who1, F who2, G who3, NumericalDist<?> dist) {
        ...
        // generate trace
        this.generateTraceForScheduling(who1, who2, who3, null, null, TimeOperations.add(presentTime(), dt), " Sampled from " + dist.getQuotedName() + ".");
	...
	public void scheduleAfter(Schedulable after, E who1, F who2, G who3) {
        ...
        // generate trace
        this.generateTraceForScheduling(who1, who2, who3, after, null, after.getEventNotes().get(after.getEventNotes().size()-1).getTime(), null);
