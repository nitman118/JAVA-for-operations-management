...
public class ReflectionManager {
	...
	/**
	 * Retrieves a method of a given class. If anything goes wrong a
	 * ReflectException is thrown. In this implementation only methods declared
	 * directly by the given class are found.
	 * 
	 * @param c
	 *            the class
	 * @param methodName
	...
	/**
	 * Retrieves a method of a given class with an empty parameter list. If
	 * anything goes wrong a ReflectException is thrown. In this implementation
	...
	/**
	 * Retrieves a constructor from a given class. If anything goes wrong a
	 * reflect exception is thrown
	 * 
	 * @param c
	 *            the class
	 * @param params
	...
	/**
	 * Invokes a constructor. If anything goes wrong a reflect exception is
	 * thrown
	 * 
	 * @param c
	...
	/**
	 * Retrieves a field from a given class. In this implementation only fields
	 * declared directly by the given class are found. On errors a reflect
	 * exception is thrown.
	 * 
	 * @param c
	 *            the class
	...
	/**
	 * Returns the value of the given field has in the specified object. On any
	 * error a reflect exception is thrown
	 * 
	 * @param owner
	 *            the object who owns the field
	 * @param field
	 *            the field
	...
	/**
	 * Sets the value of the given field of the specified object. On errors a
	 * reflect exception is thrown.
	 * 
	 * @param owner
