...
public class ReportStylerPanel extends JPanel {
	 ...
	 */
	private String sourceReportXSLFilename = XSL_PATH + "reportHTML10R15P.xsl";

	private String sourceTraceXSLFilename = XSL_PATH + "traceHTML.xsl";

	private String sourceReportParamXSLFilename = XSL_PATH + "reportHTMLParam.xsl";

	private String sourceTraceParamXSLFilename = XSL_PATH + "traceHTMLParam.xsl";
	...
	private String reportParamXSLFilename = userDir + "reportHTMLParam.xsl";

	private String traceParamXSLFilename = userDir + "traceHTMLParam.xsl";
	...
	/**
	 * set the maximum numbers for reporters and reporter-parameters that can be
	 * selected.
	 */
	 ...
	 * 
	 * @param filename
	 *            String: The name of the XSL file the report-ouptut is to be
	 *            formated with.
	 */
	 ...
	 * 
	 * @param filename
	 *            String: The name of the XSL file the trace-ouptut is to be
	 *            formated with.
	 */
	 ...
	 * 
	 * @param filename
	 *            String: The name of the report-output XML file.
	 */
	 ...
	 * 
	 * @param filename
	 *            String: The name of the trace-output XML file.
	 */
	 ...
	 * 
	 * @param filename
	 *            String: The name of the a new report-parameter XSL file.
	 */
	 ...
	 * 
	 * @param filename
	 *            String: The name of the a new trace-parameter XSL file.
	 */
	...
	/**
	 * updates the current view of the Panel with values for baseFilename.
	 * basefilname gives the path to xml-files without the _trace.xml /
	 * _report.xml endings
	 */
	...
	/**
	 * this function returns a vector with the elements startTime and stopTime,
	 * a vector with the list of entities and a vector with the list of events
	 * of the trace in the file xmlTraceFilename.
	 */
	...
	/**
	 * updates reporterPanel showing all reporters of the current report and
	 * there parameters
	 */
	...
	/**
	 * writeTraceParameters gets the data from the TracePanel. A DOM-tree with
	 * the data is constructed and then serialized and written into
	 * traceParamXSLFilename
	 */
	...
	/**
	 * writeReportParameters gets the data from the ReportPanel. A DOM-tree with
	 * the data is constructed and then serialized and written into
	 * reportParamXSLFilename
	 */
	...
	/**
	 * load the Trace Parameters from traceParamXSLFilename to be selected in
	 * the TracePanel
	 */
	...
	/**
	 * load the Report Parameters from reportParamXSLFilename to be selected in
	 * the ReportPanel
	 */
		...
		for (int i = 0; i < tabbedReportPane.getComponentCount(); i++) {
			...
			if (parameterValues.contains(repType)) {
				...
				for (int j = 0; j < paramPanel.getComponentCount(); j++) {
					...
					} else if (parameterVector.contains(reporterNo
							+ "allParam:1")) {
						param.setSelected(true);
