 ...
 * into/from yard in a container terminal. Crane is derived from SimProcess. Its
...
public abstract class Crane extends SimProcess {
	...
	/**
	 * The queue where this crane has to wait for an internal Transporter (AGV,
	 * chassis) to load it.
	 */
	 ...
	 * terminal. Implement its <code>lifeCycle</code> method to specify its
	 * behavior.
	 * 
	 * @param owner
	 *            desmoj.Model : The model this Crane is associated to.
	 * @param name
	 *            java.lang.String : The name of this Crane.
	 * @param bufferCapacity
	 *            int : The maximum number of containers(goods) this Crane can
	 *            store in its buffer.
	 * @param cs
	 *            <code>C_Control</code>: The crane control which this Crane
	 *            belongs to.
	 * @param showInTrace
	 *            boolean : Flag, if this Crane should produce a trace output or
	 *            not.
	 */
	public Crane(Model owner, String name, int bufferCapacity, C_Control cs,
		...
		this.buffer = new Stock(owner, this.getQuotedName() + "_buffer", 0,
				(long) this.bufferCapacity, false, true);
	...
	/**
	 * This method describes the loading action of this crane. In this simple
	 * case only the time it takes to load a container (an unit). The number and
	 * time of loaded units were counted in this method.
	 * 
	 * @param time
	 *            SimTime : The loading time.
	 */
	public void load(SimTime time) {
		...
		this.cs.getCS().addSumLoadTime(time.getTimeValue());
		this.sumTimeLoad = this.sumTimeLoad + time.getTimeValue();

	}

	/**
	 * This method describes the unloading action of this crane. In this simple
	 * case only the time it takes to unload a container (an unit). The number
	 * and time of unloaded units were counted in this method.
	 * 
	 * @param time
	 *            SimTime : The unloading time.
	 */
	public void unload(SimTime time) {
		...
		this.cs.getCS().addSumUnloadTime(time.getTimeValue());
		this.sumTimeUnload = this.sumTimeUnload + time.getTimeValue();

	}

	/**
	 * This method describes the driving of the crane ( crane speader). In this
	 * simple case only the time it takes to drive.
	 * 
	 * @param time
	 *            SimTime : The time to drive.
	 */
	public void drive(SimTime time) {
	 ...
	 * 
	 * @param s
	 *            Ship : The new ship for this crane .
	 */
	 ...
	 * 
	 * @param cs
	 *            <code>C_Control</code>: The new crane control for this
	 *            crane.
	 */
	 ...
	 * 
	 * @param b
	 *            <code>Stock</code>: The new buffer for this crane.
	 */
	 ...
	 * an internal transporter before loading it. In this simple case only the
	 * time it takes to load the internal transporter with the
	 * <code>Loading</code> action.
	 * 
	 * @param loading
	 *            <code>Loading</code>: The loading process.
	 */
	public boolean load(Loading loading) {
	 ...
	 * for an internal transporter before unloading it. In this simple case only
	 * the time it takes to unload the internal transporter with the
	 * <code>Unloading</code> action.
	 * 
	 * @param unloading
	 *            <code>Unloading</code>: The unloading process.
	 */
	public boolean unload(Unloading unloading) {
	 ...
	 * unloaded by this crane. If the crane is not idle, the internal
	 * trasnporter will wait by the crane for his unloading.
	 */
	public boolean waitOnUnloading() {
	...
	/**
	 * This method must be used by an internal transporter if he wants to be
	 * loaded by this crane. If the crane is not idle, the internal trasnporter
	 * will wait by the crane for his loading.
	 */
	public boolean waitOnLoading() {
	 ...
	 * 
	 * @param wq
	 *            <code>WaitQueue</code>: The waiting load queue for this
	 *            crane .
	 */
	 ...
	 * 
	 * @param wq
	 *            <code>WaitQueue</code>: The waiting unload queue for this
	 *            crane .
	 */
