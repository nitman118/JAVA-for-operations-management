 ...
 * ProcessStationNonAbstrResAnimation or
 * ProcessStationAbstrResAnimation or
 ...
 */
@Deprecated
public class ProcessStationOldAnimation<Res extends EntityBasicAnimation,  Proc extends EntityBasicAnimation> extends ModelComponent {
	...
	public ProcessStationOldAnimation(ModelAnimation owner, String name, 
		...
		if(this.showInAnimation){
			try {
				if(init)	c = Command.getCommandInit("createProcess", this.cmdGen.getAnimationTime(simTime));
				else 		c = Command.getCommandTime("createProcess", this.cmdGen.getAnimationTime(simTime));
	...
	public boolean insertRes(Res e){
		...
		if(this.showInAnimation){
			try {
				if(init)	c = Command.getCommandInit("setProcess", this.cmdGen.getAnimationTime(simTime));
				else 		c = Command.getCommandTime("setProcess", this.cmdGen.getAnimationTime(simTime));
				c.addParameter("ProcessId", this.id);
