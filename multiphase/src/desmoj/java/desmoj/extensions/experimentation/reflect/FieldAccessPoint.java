...
/**
 * An AccessPoint for an attribute (field) of a class. This pattern can be found 
 * in several frameworks for agent- or component-based simulation (e.g. 'Probes' 
 * in Swarm - see www.swarm.org). The term 'access point' was adopted from the 
 * dissertation "Ein flexibler, CORBA-basierter Ansatz fuer die verteilte, 
...
public class FieldAccessPoint implements AccessPoint {
	 ...
	 * declaring object. The parameter <code>fieldName</code> must denote a
	 * field declared in the class of <code>declaringObject</code> or
	 * inherited from one of its superclasses.
	 * 
	 * @param fieldName
	 *            the name of the field to be inspected
	 * @param accessed
	 *            the object whose field values are to be inspected
	 * @SBGen Constructor
	 */
	...
	/**
	 * constructs an access point object from the given field and object. The 
	 * parameter <code>inspectableField</code> must reference a field declared
	 * in the class of <code>declaringObject</code> or inherited from one of its
	 * superclasses.
	 * 
	 * @param inspectableField
	 *            the field to be inspected
	 * @param accessed
	 * 				the accessed object
	 */
	 ...
	 * 
	 * @param name
	 *            the name for this access point
	 * @param fieldName
	 *            the name of the field to be inspected
	 * @param accessed
	 *            the object whose field values are to be inspected
	 ...
	 *            the class whose field is to be inspected
	 */
	 ...
	 * class of <code>declaringObject</code> or inherited from one of its
	 * superclasses. The name of the access point may differ from the field's name.
	 * 
	 * @param name
	 *            the name for this access point
	 * @param inspectableField
