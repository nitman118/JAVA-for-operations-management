...
public class StationGrafic extends JComponent implements Grafic{
	...
	private desmoj.extensions.visualization2d.engine.model.Station 	station;
	private String			code;
	 ...
	 * @return 	smallest rectangle when an StationGrafic exist,
	 * 			null otherwise
	 */
	...
	public StationGrafic(Station station, String viewId, Point pointExtern) {
		...
		if(this.station.getName() != null) 	this.code = this.station.getName();
		else 								this.code = "id: "+this.station.getId();
