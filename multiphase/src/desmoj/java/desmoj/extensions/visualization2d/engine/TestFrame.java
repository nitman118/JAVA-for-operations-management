 ...
 * Only for devoloper. It's may be not correct.
 * 
...
public class TestFrame extends JFrame{
	...
	public TestFrame()throws desmoj.extensions.visualization2d.engine.model.ModelException, ModelGraficException{
		super("Fenster Titel");
		...
		desmoj.extensions.visualization2d.engine.viewer.SimulationTime simTime = new SimulationTime(0, 10000 ,0.1, null, null);
		URL url = null;
		try {
	...
	public void testInit()throws ModelException, ModelGraficException{
		...
		this.model.createModelBasisData(new String[0], new String[0], new String[0], "test", "cm", new String[0], new String[0], new String[0], new String[0], new String[0], new String[0], new String[0],true, 0);
		...
		entity.createGraficStatic("otto", 600.0, 50.0, -Math.PI/4.0, true, model.getSimulationTime().getSimulationTime());
		...
		java.awt.Point[] points = new java.awt.Point[1];
		points[0]	= new java.awt.Point(250,250);
		r.createGrafic(points);
		r.addToContainer("Krause", this.model.getSimulationTime().getSimulationTime());
		
		entity = new Entity(this.model, "Res1", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Res2", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Pat11", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Pat1", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Pat2", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Res11", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		...
		*/
		...
		entity = new Entity(this.model, "Res1a", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Res2a", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Pat11a", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Pat1a", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Pat2a", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Res11a", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		...
		entity = new Entity(this.model, "Res1b", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Res2b", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Pat11b", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Pat1b", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Pat2b", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		entity = new Entity(this.model, "Res11b", "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		entity.createGraficFree(this.model.getSimulationTime().getSimulationTime());
		...
		Statistic statistic = new Statistic(this.model, "4713", Statistic.DATA_Observations, Statistic.INDEX_Mean_StdDev, false, 0, 4000, 1100.0, 1700.0, 3);
		...
		*/
		...
		BackgroundElement painting = new BackgroundElement(this.model, "4789", null, BackgroundElement.TEXT_POSITION_Middle, 
		...
		BackgroundElement painting1 = new BackgroundElement(this.model, "4788", "hugo<BR>eva", BackgroundElement.TEXT_POSITION_Middle, 
		...
		BackgroundElement painting2 = new BackgroundElement(this.model, "4787", "TEST", BackgroundElement.TEXT_POSITION_Middle, 
	...
	public void grafikTestRun()throws ModelException, ModelGraficException{
		...
		for(int i=0; i<1; i++){
			Entity e = new Entity(this.model, "P"+i, "Patient", "active", this.model.getSimulationTime().getSimulationTime());
		...
		for(int i=10; i<40; i++){
			...
			this.model.getStatistics().get("4713").update(i*100.0, this.model.getSimulationTime().getSimulationTime());
			this.model.getStatistics().get("4713").update(i*100.0+ 5000.0, this.model.getSimulationTime().getSimulationTime());
