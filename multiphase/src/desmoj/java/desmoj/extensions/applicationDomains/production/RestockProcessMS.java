...
/**
 * RestockProcessMS is a process restocking a <code>Stock</code> up to a
...
public class RestockProcessMS extends SimProcess implements
	...
	/**
	 * The quantity of units the <code>Stock</code> will be replenished with.
	 * Will be recalculated in every cycle: Maximum inventory level minus actual
	 * available units in the Stock (when the inventory level dropped below the
	 * safety stock level).
	 */
	 ...
	 * receipt of an order) will be given as a real random number distribution.
	 * 
	 * @param owner
	 *            Model : The model this <code>RestockProcessMS</code> is
	 *            associated to
	 * @param name
	 ...
	 *            zero.
	 * @param showInTrace
	 *            boolean : Flag for showing the <code>RestockProcessMS</code>
	 ...
	 * 
	 * @return long : The maximum inventory level up to which the Stock will be
	 *         refilled in every cycle.
	 */
	...
	/**
	 * Returns the safety stock level. When this inventory level is reached a
	 * new order will be placed.
	 * 
	 * @return long : The safety stock level. When this inventory level is
	 *         reached a new order will be placed.
	 */
	 ...
	 * changes. If the inventory level of the Stock drops below the safety stock
	 * level this RestockProcessMS must be woken up to place an order.
	 * 
	 * @param evt
	...
	/**
	 * Sets the maximum inventory level to a new value. Make sure it is greater
	 * than zero and less than the capacity of the Stock.
	 * 
	 * @param newMaxInventoryLevel
	 *            long : The new maximum inventory level. Make sure it is
	 *            greater than zero and less than the capacity of the Stock.
	 */
	...
	/**
	 * Sets the safety stock level to a new value. Make sure it is greater than
	 * zero and less than the capacity of the Stock.
	 * 
	 * @param newSafetyStk
