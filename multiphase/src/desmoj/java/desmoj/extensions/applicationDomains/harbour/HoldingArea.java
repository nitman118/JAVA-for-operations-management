...
public class HoldingArea extends WaitQueue {
	 ...
	 * 
	 * @param owner
	 *            desmoj.Model : The model this HoldingArea is associated to.
	 * @param name
	 *            java.lang.String : The name of this HoldingArea.
	 * @param mSortOrder
	 ...
	 *            processes can be enqueued. Zero (0) means unlimited capacity.
	 * @param int
	 *            nLanes: the number of the lanes of this HoldingArea.
	 * @param showInReport
	 ...
	 * 
	 * @param l
	 *            <code>Lane</code>: The lane which should be returned to the
	 *            HoldingArea.
	 */
