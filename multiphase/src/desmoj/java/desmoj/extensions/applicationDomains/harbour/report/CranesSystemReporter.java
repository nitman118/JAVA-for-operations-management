...
public class CranesSystemReporter extends StockReporter {
	...
	/**
	 * The column headings of the queues (transporter and cranes) part of this
	 * CranesSystemReporter. Entries should contain the elements in the same
	 * order as the <code>csEntries[]</code>.
	 */
	private String csColumns[];

	/**
	 * The data entries of the queues (transporter and cranes) part of this
	 * CranesSystemReporter. The entries should contain the data elements in the
	 * same order as defined in the <code>csColumns[]</code> array.
	 */
	private String csEntries[];

	/**
	 * The number of columns of the queues (transporter and cranes) part of this
	 * CranesSystemReporter.
	 */
	private int csNumColumns;

	/**
	 * Constructor for a new CranesSystemReporter. Note that although any
	 * Reportable is accepted you should make sure that only subtypes of
	 * TransporterSystem are passed to this constructor. Otherwise the number of
	 * column titles and their individual headings will differ from the actual
	 * content collected by this reporter.
	 * 
	 * @param informationSource
	 *            desmoj.Reportable : The CranesSystem to report about
	 */
	...
	public String[] getEntries() {
		...
		if (source instanceof desmoj.extensions.applicationDomains.harbour.CranesSystem) {
			...
			desmoj.extensions.applicationDomains.harbour.CranesSystem cs = (desmoj.extensions.applicationDomains.harbour.CranesSystem) source;
	 ...
	 *         queues part of this CranesSystemReporter.
	 */
