 ...
 * within the simulation or to include external sources of (preudo) 
...
public abstract class Series<O extends Object> extends Distribution {
	...
	/**
	 * Reading Direction of the value list. False: Forward (default) True:
	 * Backwards
	 */
	...
	/**
	 * Creates a new Series. Default behaviour when returning samples is -
	 ...
	 * 
	 * @param direc
	 *            boolean : true - forward; false - backwards
	 */
	 ...
	 * the last sample has been returned. If the list is getting read backwards,
	 * enabling this will cause the series to start over from the end of the
	 * list once the first value has been read.
	 * 
	 * @param repeat
	 *            boolean : Whether this series repeats its value list once the
	 ...
	 * 
	 * @param position
	 *            int : The position to remove the value from.
	 */
	 ...
	 * 
	 * @param collection
	 *            Collection<E> : The collection whose entries will be added.
	 */
	 ...
	 * 
	 * @param element
	 *            E : The new entry to replace the old one.
	 * @param position
	 *            int : The position at which the entry should be replaced.
	 */
    ...
    /**
     * Convenience method to return the series' sample as <code>Object</code>.
