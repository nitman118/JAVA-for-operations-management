 ...
 * time the <code>ValueSupplier</code> object has changed or at every tick of
 ...
 * Then each line of the file contains a SimTime value and the value of the <code>ValueSupplier</code>
 * object at that point of time in the simulation, separated by a ";". <br>
 * One can choose when the recording of the values will start and stop. See the
 * constructor for further information. <br>
 * Reseting the <code>TimeSeries</code> object will delete the contents of the
 * file. <br>
 * This <code>TimeSeries</code> object will be the observer of the
 * <code>ValueSupplier</code> object given in the constructor. When
 * constructing a new <code>TimeSeries</code> object it will be added to the
 * list of observers of the <code>ValueSupplier</code>. That means this
 ...
 * Valuesupplier) ";" is used. See also FileOutput.
 * 
...
public class TimeSeries extends desmoj.core.statistic.StatisticObjectSupportingTimeSpans {
    ...
    /**
     * The graphical observer (ChartPlotter) this time series is connected to.
     * 'null' if there is no observer.
     * If there is a connected plotter, the values have to be kept in memory and
     * not only written to a file. 
     */
     ...
     *            be shown in trace.
     *            
     * @deprecated Prefer the constructor with an additional <code>showInReport</code> at second last argument.           
     */
    public TimeSeries(Model ownerModel, String name, String fileName,
            TimeInstant start, TimeInstant end, boolean showInTrace) {
        this(ownerModel, name, start, end, false, showInTrace);
    }
     ...
     *            it to <code>true</code> if TimeSeries should show up in
     *            report. Set it to <code>false</code> if TimeSeries should not
     *            be shown in report.
     * @param showInTrace
     *            boolean : Flag for showing this TimeSeries in trace files. Set
     *            it to <code>true</code> if TimeSeries should show up in
     ...
     *            the file.
     * @param start
     *            SimTime : The point of SimTime this TimeSeries will start to
     *            save the values to the file.
     * @param end
     *            SimTime : The point of SimTime this TimeSeries will stop to
     *            save the values to the file. Choose an end time that lies
     *            before the start time to record the values for all the time.
     * @param showInTrace
     *            boolean : Flag for showing this TimeSeries in trace files. Set
    ...
    public TimeSeries(Model ownerModel, String name, String fileName,
        ...
        this(ownerModel, name, fileName, valSup, start, end, automatic, false, showInTrace);
    }
     ...
     *            be shown in trace.
     */
    public TimeSeries(Model ownerModel, String name, TimeInstant start, TimeInstant end, boolean showInReport, boolean showInTrace) {
    ...
    public TimeSeries(Model ownerModel, String name, 
            ValueSupplier valSup, TimeInstant start, TimeInstant end,
            boolean automatic, boolean showInTrace) {
        this(ownerModel, name, valSup, start, end, automatic, false, showInTrace);
    }
	...
	/**
     * Returns a default Reporter! In addition, all data (values) can be
     * saved in a file or displayed in the GraphicalObserver. <br>
    ...
    /**
     * Returns the actual value of the <code>ValueSupplier</code> which values
     ...
     * which all the data is saved to. The name of the file will remain the
     * same. This is done by closing and opening the existing file.
     */
    public void reset() {
    ...
    /**
     * Updates this <code>TimeSeries</code> object by fetching the actual
    ...
    /**
     * Updates this <code>TimeSeries</code> object with the double value given
     * as parameter. In some cases it might be more convenient to pass the value
     * this <code>ValueStatistics</code> will be updated with directly within
     * the <code>update(double val)</code> method instead of going via the
     * <code>ValueSupplier</code>.
     * 
     * @param val
     *            double : The value with which this <code>TimeSeries</code>
     *            will be updated.
     */
     ...
     * @param arg
     *            Object : The Object with which this <code>TimeSeries</code>
     *            is updated.
     */
     ...
     * Advises this object to keep the values in the memory, because the TimeSeriesPlotter
     * requires this. 
