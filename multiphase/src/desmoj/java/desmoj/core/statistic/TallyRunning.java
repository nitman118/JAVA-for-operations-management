 ...
 * the last <i>n</i> samples only, subject to <i>n</i> passed to the
 * constructor.
 * 
 * @see Tally
...
public class TallyRunning extends desmoj.core.statistic.Tally {
     ...
     *            object.
     * @param n
     *            int : Number of samples to include in running statistic data.   
     * @param showInReport
    ...
    /**
     * Returns the mean value of the last <i>n</n> values observed.
     * Note that if less than n samples values are observed this far, the value returned 
     * will only include fewer (i.e. all) samples. 
     * 
    ...
    /**
     * Returns the standard deviation of the last <i>n</n> values observed.
     * Note that if less than n samples values are observed this far, the value returned 
     * will only include fewer (i.e. all) samples. 
     * 
    ...
    /**
     * Updates this <code>TallyRunning</code> object by fetching the actual value of
    ...
    /**
     * Updates this <code>TallyRunning</code> object with the double value given as
     * parameter. In some cases it might be more convenient to pass the value
     * this <code>TallyRunning</code> will be updated with directly within the
     * <code>update(double val)</code> method instead of going via the
     * <code>ValueSupplier</code>.
     * 
     * @param val
     *            double : The value with which this <code>TallyRunning</code> will
     *            be updated.
     */
     ...
     * @param arg
     *            Object : The Object with which this <code>TallyRunning</code> is
