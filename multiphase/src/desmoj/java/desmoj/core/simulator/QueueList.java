...
public abstract class QueueList<E extends Entity> implements PropertyChangeListener, Iterable<E> {
	 ...
	 * queueing discipline (like FIFO or LIFO or ...). Is used to display the
	 * queueing discipline in the report of the QueueBased objects.
	 * 
	 ...
	 * 
	 * @return boolean : Is <code>true</code> if no entities are stored in the
	 *         queue at the moment, <code>false</code> otherwise.
	 */
	 ...
	 * 
	 * @return boolean : Is <code>true</code> if the first <code>Entity</code>
	 *         in the queue is removed successfully, <code>false</code>
	 *         otherwise.
	 */
	 ...
	 * <code>true</code> if done successfully, <code>false</code> otherwise.
	 * 
	 * @return boolean : Is <code>true</code> if the last <code>Entity</code>
	 *         in the queue is removed successfully, <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * Should send a warning to the error output by forwarding it to the
	 * associated <code>QueueBased's sendWarning</code> method. Warnings
	 * should only be sent if the <code>QueueBased</code>'s flag for queue
