 ...
 * static <code>equals(InterruptCode a, InterruptCode b)</code> method. It
...
public class InterruptCode extends NamedObject {
	 ...
	 * interrupt code object. The constructor provides the new interrupt code
	 * object with same name and internal codenumber as the interrupt code
	 ...
	 * 
	 * @param name
	 *            java.lang.String : The interrupt code's name
	 */
	...
	/**
	 * Returns <code>true</code> if the two given interrupt codes have the
	 * same internal code, <code>false</code> otherwise.
	 * 
	 * @return boolean : Is <code>true</code> if the two given interrupt codes
	 *         have the same internal code, <code>false</code> otherwise
	 * @param a
	 *            desmoj.InterruptCode : First comparand
	 * @param b
	 *            desmoj.InterruptCode : Second comparand
	 */
