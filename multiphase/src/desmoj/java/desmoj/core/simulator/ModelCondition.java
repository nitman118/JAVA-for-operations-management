 ...
 * experiment. Override method check(E e) such that it returns 
...
public abstract class ModelCondition extends ModelComponent {
     ...
     * implement this abstract method to return true if the model
    ...
    @Deprecated
    /**
     * @deprecated Use ModelCondition instead of Condition for conditions
     * not referring to a single entity.
     * 
     * A wrapper to use a Condition's check() as a ModelCondition.
     * 
     * @version DESMO-J, Ver. 2.4.2 copyright (c) 2014
     * @author Tim Lechler
     * 
    ...
    protected static class ConditionWrapper extends ModelCondition {
        ...
        /**
         * Stores the condition to evaluate.
         */
        Condition<?> _cond;
        
        /**
         * Constructs a ConditionWrapper.
         * 
         * @param owner
         *            Model : The main model this ConditionWrapper is associated to
         * @param cond
         *            Condition<?> : The condition to evaluate
         */
        ConditionWrapper(Model owner, Condition<?> cond) {
            super(owner, "Wrapper of " + cond, false);
            this._cond = cond;
        }

        /**
         * Returns a boolean showing whether the model complies to the
         * internal condition or not. 
         * 
         * @return boolean : Is <code>true</code>, if the model conforms
         *         to the condition, <code>false</code> otherwise.
         */
