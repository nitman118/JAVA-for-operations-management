...
public class VanCarrier extends SimProcess {
    ...
    /**
     * a reference to the model this process is a part of useful shortcut to access
     * the model's static components
     */
     ...
     * customer waiting. If there is someone waiting a) remove customer from queue
     * b) serve customer c) return to top If there is no one waiting a) wait
     * (passivate) until someone arrives (who reactivates the VC) b) return to top
     */
