...
<Proc extends EntityBasicAnimation, Res extends EntityBasicAnimation> extends ModelComponent {
	 ...
	 */
	 public ProcessStationAnimation(ModelAnimation owner, String name, 
		 ...
		 this(owner, name, null, pos, form, (ListInterface)null, showInAnimation);
	 }
	  ...
	  * @param showInAnimation	switch animation on or off
	  */
	 public ProcessStationAnimation(ModelAnimation owner, String name, Comment comment,
				Position pos, FormExt form, boolean showInAnimation){
		 this(owner, name, comment, pos, form, (ListInterface)null, showInAnimation);
	 }
	 ...
	 * @param showInAnimation	switch animation on or off
	  ...
	  * @param procEntities		List of process entities		
	  * @param resEntities		List of resource entities
	  * @return true, when successful
	  */
	 public boolean insert(java.util.List<Proc> procEntities, java.util.List<Res> resEntities){
		TimeInstant simTime = this.model.presentTime();
		boolean	init	= this.cmdGen.isInitPhase();
		Command c;
