	...
	public BinAnimation(ModelAnimation owner, String name, long initialUnits,  
	 ...
	 public void createAnimation(Position pos, FormExt form,
		...
		if(this.showInAnimation){
			try {
				if(init)	c = Command.getCommandInit("createBin", this.cmdGen.getAnimationTime(simTime));
				else 		c = Command.getCommandTime("createBin", this.cmdGen.getAnimationTime(simTime));
	 ...
	 public boolean retrieve(long noOfProducts){
		...
		if(this.showInAnimation){
			try {
				if(init)	c = Command.getCommandInit("setBin", this.cmdGen.getAnimationTime(simTime));
				else 		c = Command.getCommandTime("setBin", this.cmdGen.getAnimationTime(simTime));
				c.addParameter("BinId", this.id);
