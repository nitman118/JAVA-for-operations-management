 ...
 * MachineProcess is derived from SimProcess. Its <code>lifeCycle()</code>
...
public abstract class MachineProcess extends SimProcess {
	 ...
	 * 
	 * @param owner
	 *            desmoj.Model : The model this MachineProcess is associated to.
	 * @param name
	 *            java.lang.String : The name of this MachineProcess.
	 * @param showInTrace
	 *            boolean : Flag, if trace messages of this MachineProcess
	 *            should be displayed in the trace file or not.
	 */
	 ...
	 * MachineProcess specific behaviour. It should contain at least something
	 * to let this MachineProcess wait in a <code>WorkStation</code> for parts
	 * to process them, like <br>
	 * <code> WorkStationXY.cooperate(processing);</code><br>
	 * This <code>lifeCycle()</code> method starts after a MachineProcess has
