 ...
 * SimpleTransporter returns to his <code>TranspsortJunction</code> where it
 * waits again for some other goods to transport. The time it takes the
 * transporter to return to its <code>TransportJunction</code> must be
 * specified in the parameter <code>returnTime</code>. It must be some kind
 * of <code>desmoj.core.dist.NumericalDist</code> random number stream. The
 ...
 * in a <code>TransportJunction</code> for goods to be transported. Than,
...
public class SimpleTransporter extends Transporter {
	 ...
	 * to. From there it starts and to that <code>TransportJunction</code> it
	 * returns.
	 */
	private TransportJunction homeBase;

	/**
	 * The <code>Transportation</code> this SimpleTransporter is performing.
	 * That is the joint cooperation of this SimpleTransporter and the goods (
	 ...
	 * certain <code>TransportJunction</code> as his home base. He will
	 ...
	 *            to.
	 * @param name
	 *            java.lang.String : The name of this SimpleTransporter.
	 * @param minLoad
	...
	/**
	 * Returns the home base <code>TransportJunction</code> this
	...
	/**
	 * Returns the <code>Transportation</code> order this SimpleTransporter is
	 * supposed to execute.
	 * 
	 * @return desmoj.Transportation : The <code>Transportation</code> order
	 *         this SimpleTransporter is supposed to execute.
	 */
	...
	/**
	 * This SimpleTransporter has a very simple lifeCycle. He waits in his home
	 * base (<code>TransportJunction</code>) for goods to transport. As soon
	 * as goods arrive at the <code>TransportJunction</code> they will be
	...
	/**
	 * Sets a new <code>TransportJunction</code> as the home base this
	 * SimpleTransporter is associated to. Must not be <code>null</code>!
	 * 
	 * @param newHomeBase
	...
	/**
	 * Sets a new <code>Transportation</code> order this SimpleTransporter is
	 * supposed to carry out. Must not be <code>null</code>!
	 * 
	 * @param newTransportation
	 *            desmoj.Transportation : The new <code>Transportation</code>
