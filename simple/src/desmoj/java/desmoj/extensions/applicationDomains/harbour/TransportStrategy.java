 ...
 * transporter control uses by the assigning of the jobs to transporters. The
 * method getJobs (ProcessQueue Transporter, Queue Jobs) that gives the
 * transport control the pairs of the assigned jobs with their transporters -
...
public interface TransportStrategy {
	 ...
	 * 
	 * @param Transporter
	 *            <code>ProcessQueue</code>: The queue with the transporters
	 ...
	 */
	public TransporterJob[] getJobs(ProcessQueue Transporter, Queue Jobs);
}