...
public class AccessPointTableModel extends AbstractTableModel {
	 ...
	 * 
	 * @param accessPoints
	 *            a map containing access point objects
	 */
	...
	public String getColumnName(int col) {
		if (col == 0)
			...
			return "Column " + String.valueOf(col);
	}
	...
	/**
	 * Returns the editable status of the cell at the given index. Only cells
	 * representing MutableAccessPoints are editable
	 * 
	 * @param row
	 *            row index
	 * @param col
