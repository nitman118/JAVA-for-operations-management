 ...
 */
public abstract class AbstractNumericalCoorChartCanvas<N extends Number> extends AbstractNumericalChartCanvas<N> implements CanvasCoordinateChart<N> {
	
	/** The chart data displayed in this canvas. */
    protected AbstractChartData<N> chartData;
    
    /**
     * An array containing the color that represents each data.
     * The order of the entries in this array should be the same as those in chartData.
     */
	 ...
	 * 			
	 */
	public AbstractNumericalCoorChartCanvas(String canvasID, int canvasHeight, int canvasWidth, AbstractChartData<N> data) {
