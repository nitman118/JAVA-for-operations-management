 ...
 * MT19937 and has a period of 2<sup>19937</sup> - 1; see <a
 * href="http://en.wikipedia.org/wiki/Mersenne_twister">the Mersenne twister
...
public class MersenneTwisterRandomGenerator implements
	...
	/**
	 * The repository for storing random numbers (which also denote the state of
	 * the generator)
	 */
	...
	/**
	 * Creates a MersenneTwisterRandomGenerator with seed 42. The value 42 has
	 * been taken by pure coincidence. It is not really related to Douglas
	 * Adams' "Hitchhikers Guide to the Galaxy" trilogy of five books (so far).
	 */
