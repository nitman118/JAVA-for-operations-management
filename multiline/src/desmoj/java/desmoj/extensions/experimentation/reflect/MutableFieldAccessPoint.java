 ...
 * 
 * This pattern can be found in several frameworks for agent-
...
public class MutableFieldAccessPoint extends FieldAccessPoint implements
	...
	/**
	 * Creates a new MutableFieldAccessPoint for the given field. The name is
	 ...
	 * field name and declaring class. The access point might have a name different
	 * from the field name.
	 * 
	 * @param fieldName
	...
	/**
	 * Creates a new MutableFieldAccessPoint for the field specified by the given
	 * field name and object. The access point's name is equal to the field
	 * name.
	 * 
	 * @param fieldName
	 *            the name of the field to access
	 * @param accessed:
	 *            The object possesing the field
	 */
