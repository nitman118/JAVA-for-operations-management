...
/**
 * A Lane represents a lane where a <code>Truck</code> waits for an internal
 * transporter to get loaded/unloaded by him at a <code>Holding Area</code>.
 * It has a certain number that must ne not negotive.
 * 
 * @see Entity
 * 
...
public class Lane extends Entity {
	 ...
	 * 
	 * @param owner
	 *            desmoj.Model : The model this Lane is associated to.
	 * @param name
	 *            java.lang.String : The name of this Lane.
	 * @param number
	 *            int : The number of this Lane.
	 * @param showInTrace
	 *            boolean : Flag, if this Lane should produce a trace output or
	 *            not.
	 */
	 ...
	 * 
	 * @param n
	 *            int : The new number of this Lane.
	 */
