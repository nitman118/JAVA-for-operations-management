...
public class YardReporter extends Reporter {
	...
	/**
	 * Constructor for a new YardReporter. Note that although any Reportable is
	 ...
	 *            desmoj.Reportable : The Yard to report about
	 */
	...
	public String[] getEntries() {
		...
		if (source instanceof desmoj.extensions.applicationDomains.harbour.Yard) {
			...
			desmoj.extensions.applicationDomains.harbour.Yard y = (desmoj.extensions.applicationDomains.harbour.Yard) source;
