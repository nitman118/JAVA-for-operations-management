 ...
 * transporter get it done. TransporterJob is using to store the transporter and
 * his job to do by a transport strategy.
 * 
...
public class TransporterJob {
	 ...
	 * 
	 * @param t
	 *            InternalTransporter : The InternalTransporter.
	 * @param j
	 *            Job : The Job.
	 */
