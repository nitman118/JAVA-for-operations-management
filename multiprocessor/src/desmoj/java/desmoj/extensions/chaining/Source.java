 ...
 * the buffer queue. The user has to override the createEntity Method the create the Entity the source should send to the successor.
 * 
 * @param <E>
...
public abstract class Source<E extends Entity> extends Station<E> implements HasSuccessor<E> {
	 ...
	 * Source assumes that there is no restriction. This applies to incomingBufferQueueCapacity, maxEntitiesToHandle, parallelHandledEntities
	 * 
	 * @param maxEntitiesToProduce
	 *            the number of max entities the station can handle
	 * @param parallelProducedEntities
