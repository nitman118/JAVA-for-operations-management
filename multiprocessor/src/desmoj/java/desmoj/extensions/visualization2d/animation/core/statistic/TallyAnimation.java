...
public class TallyAnimation extends Tally{
	 ...
	 * @param name					name of Tally
	 * @param showInReport			as in Tally
	 * @param showInTrace			as in Tally
	 */
	public TallyAnimation(ModelAnimation owner, String name, 
	...
	public void createAnimation(
			TimeInstant highTime, double valMin, double valMax, int histogramCells, 
		...
		if(this.showInAnimation){
			try {
				...
				c.setRemark(this.getGeneratedBy(TallyAnimation.class.getSimpleName()));
