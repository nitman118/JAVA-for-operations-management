...
public class ExperimentStarterApplication extends JFrame implements
	 ...
	 * experiment starter loads the specified experiment configuartion file.
	 * 
	 * @param confFileName
	 *            Names of the (XML-)configuration file to be loaded.
	 */
	 ...
	 *            String: the current values of the experiment access points
	 * @param outputPath
