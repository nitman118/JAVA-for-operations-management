...
public class ContDistBeta extends ContDist {
	 ...
	 * @param alpha
	 *            double: Distribution specific parameter alpha
	 * @param beta
	 *            double : Distribution specific parameter beta
	 * @param showInReport
    ...
    public Double getInverseOfCumulativeProbabilityFunction(double p) {
        throw new UnsupportedOperationException(this.getName() + " does not support determined inverse cumulative probabilities.");
    }
}
