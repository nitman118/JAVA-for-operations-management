...
public class WorkStationReporter extends desmoj.core.report.Reporter {
	...
	/**
	 * The number of different kinds of parts (= the number of slave queues).
	 * Default is one!
	 */
	...
	/**
	 * Constructor for a new WorkStationReporter. Note that although any
	 * Reportable is accepted you should make sure that only subtypes of
	 * WorkStation are passed to this constructor. Otherwise the number of
	 * column titles and their individual headings will differ from the actual
	 * content collected by this reporter.
	 * 
	 * @param informationSource
	 *            desmoj.Reportable : The WorkStation to report about
	 */
	public WorkStationReporter(
		...
		if (informationSource instanceof desmoj.extensions.applicationDomains.production.WorkStation) {
			...
			desmoj.extensions.applicationDomains.production.WorkStation ws = (desmoj.extensions.applicationDomains.production.WorkStation) informationSource;
	...
	public String[] getEntries() {
		...
		if (source instanceof desmoj.extensions.applicationDomains.production.WorkStation) {
			...
			desmoj.extensions.applicationDomains.production.WorkStation ws = (desmoj.extensions.applicationDomains.production.WorkStation) source;
	...
	/**
	 * Returns the number of slave queues of this WorkStation. That is the
	 * number of different kinds of parts handled at this WorkStation.
	 * 
