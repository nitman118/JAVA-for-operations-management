...
/**
 * A C_Control represents the control component for the cranes. The cranes and
 * the transporters (external/internal) can activate (interrupt) the crane
 * control to begin with their serving. Its <code>lifeCycle()</code> is
 * already implemented and spezifies the behavior of the crane control.
 * 
 * @see SimProcess
 * @see CranesSystem
 * 
...
public class C_Control extends SimProcess {
	/**
	 * The cranes system that manages all the statistic of the all cranes of
	 * this crane control.
	 */
	private CranesSystem cs;

	/**
	 * The interruptCode caused by a transporters arrival to interrupt this
	 * crane control.
	 */
	private InterruptCode transporterArrival;

	/**
	 * The interruptCode caused by an idle Crane to interrupt this crane
	 * control.
	 */
	private InterruptCode craneIsFree;

	/**
	 * Constructor for a crane control C_Control for the cranes. The queueing
	 * discipline and the capacity limit of the underlying queues for the cranes
	 * and for the transporters (external/internal) can be chosen.
	 * 
	 * @param owner
	 *            Model : The model this C_Control is associated to.
	 * @param name
	 *            java.lang.String : The C_Control's name
	 * @param csortOrder
	 ...
	 *            cranes can be enqueued. Zero (0) means unlimited capacity.
	 * @param tsortOrder
	 ...
	 */
	public void transporterArrival() {
	...
	/**
	 * This method implements crane control specific behaviour. This behavior is
	 * always the same therefore there is no need to implement that in a
	 * subclass of C_Cotrol. This method starts after a crane contrl has been
	 * created and activated by the scheduler.
	 */
	 ...
	 * transporter arrives and must be served by this control. It's implemented
	 * for the case - a ship arrives and needs some cranes for his unloading
	 * and/or loading. Override this method to specify another case or behavior.
	 */
	...
	/**
	 * This method implements the specific behaviour of the crane control if a
	 * crane is idle must be served by this control. It's implemented for the
	 * case - a crane is idle and the crane control tries to find a ship that
	 * waits for his serving and this crane can be assigned to. If the crane was
	 * assigned it checks if the ship is ready and can be acivated. Override
	 * this method to specify another case or behavior.
	 */
	public void serveCrane() {

		// get the crane to serve
		Crane c = (Crane) this.cs.getCranesQueue().last();
