 ...
 * load (minimum number of goods which will be carried). Transporter is derived
 * from SimProcess. Its <code>lifeCycle()</code> must be implemented by the
 * user in order to specify the behavior of the Transporter.
 * 
 * @see SimProcess
 * @see Transportation
...
public abstract class Transporter extends SimProcess {
	 ...
	 * system. Implement its <code>lifeCycle()</code> method to specify its
	 ...
	 * carry). Both must not be zero or negative. Their default value is one.
	 * 
	 * @param owner
	 *            desmoj.Model : The model this Transporter is associated to.
	 * @param name
	 *            java.lang.String : The name of this Transporter.
	 * @param minLoad
	 ...
	 * capacity and a minimum load of one.
	 * 
	 * @param owner
	 *            desmoj.Model : The model this Transporter is associated to.
	 * @param name
	...
	/**
	 * Returns the capacity of this Transporter. That is the maximum number of
	 * goods it can carry around the manufacturing system.
	 * 
	...
	/**
	 * Returns the minimum load of this Transporter. That is the minimum number
	 * of goods which must be loaded on this Transporter before it starts
	 ...
	 * let this Transporter wait in a <code>TransportJunction</code> for goods
	 * to carry around, like <br>
	 * <code> TransportJunctionXY.cooperate(transportation);</code><br>
	 * This method starts after a Transporter has been created and activated by
	 * the scheduler. It describes the behavior of this special Transporter when
	 * he is acting alone. All action taking place when this Transporter (as a
	 * master) acts together with other <code>SimProcess</code> es (as slaves)
	...
	/**
	 * Sets the capacity of this Transporter to a new value. The new value must
	 * not be zero or negative.
	 * 
	 * @param newCapacity
	 *            int : The new capacity of this Transporter.
	 */
	...
	/**
	 * Sets the minimum load of this Transporter to a new value. The new value
