...
public class BlockReporter extends Reporter {
	...
	/**
	 * Constructor for a new BlockReporter. Note that although any Reportable is
	 * accepted you should make sure that only subtypes of Block are passed to
	 ...
	 *            desmoj.Reportable : The Block to report about
	 */
	...
	public String[] getEntries() {
		...
		if (source instanceof desmoj.extensions.applicationDomains.harbour.Block) {
			...
			desmoj.extensions.applicationDomains.harbour.Block b = (desmoj.extensions.applicationDomains.harbour.Block) source;
