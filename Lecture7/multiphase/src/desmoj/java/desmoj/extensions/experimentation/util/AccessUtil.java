...
public class AccessUtil {
	...
	/**
	 * Put an access point into the given map. The access point will be the value
	 * and the access point's name will be the key.
	 ...
	 * @return the internal index of a given access point name. 
	 * 		If the access point does not exist -1 is returned
	 */
	...
	/**
	 * sets the specified access point to the given value. Returns true if this was
	 * successful (i.e. if the access point is mutable) or false otherwise.
	 * 
	 * @param accName
	 *            the name of the access point to change
	 * @param value
	 *            the value to set the accessed attribute to.
	 * @param accessPoints a map containing access points
	 ...
	 * of values.
	 * This map must contain key/value pairs where the key is a string
	 * corresponding to an access point's name and the value is an object fitting the
	 * accessed attributes type.
	 * 
	 * @param accessPoints a map containing access points
	 * @param m
	 *            a java.util.Map to initialize the given map of access points from.
	 */
