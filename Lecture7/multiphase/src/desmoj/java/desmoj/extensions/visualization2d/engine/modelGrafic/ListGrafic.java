...
public class ListGrafic extends JPanel implements Grafic{
	...
	private desmoj.extensions.visualization2d.engine.model.List 		list;
	 ...
	 * @return 	smallest rectangle when an ListGrafic exist,
	 * 			null otherwise;
	 */
	 ...
	 * @param list
	 */
	public ListGrafic(desmoj.extensions.visualization2d.engine.model.List list, String viewId, Point pointExtern, 
		...
		if(list.getName() != null) 	this.code = this.list.getName();
		else 						this.code = "id: "+this.list.getId();
	 ...
	 * Will be called from List.add and List.remove.
	 */
	public void update(){
