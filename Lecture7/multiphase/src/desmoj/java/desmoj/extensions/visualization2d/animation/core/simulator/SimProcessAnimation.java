...
/**
 * Animation of a SimProcess. It extends from SimProcess.
 * A SimProcess is animated by an entity. Free and static entities are
 * supported. 
...
public abstract class SimProcessAnimation extends SimProcess implements EntityBasicAnimation{
	 ...
	 * and can be included in Containers, as Queues, Processes, ect. 
	 * @param entityTypeId		entitType of Entity 
