 ...
 * Data of a chart, which display a relationship between two variables:
 * Strings and values from type <code>Double</code>.
 * 
...
public class ChartDataHistogramDouble extends AbstractChartDataTable<Double> {
	 ...
	 */
	public ChartDataHistogramDouble(Model ownerModel, String[] strings, Double[] entries) {
	...
	public String getObservedString(int index) {
		if (index < 0 || index >= _observedStrings.length) return "";
