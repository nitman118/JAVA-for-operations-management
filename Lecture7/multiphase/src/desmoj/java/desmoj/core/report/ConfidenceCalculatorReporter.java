...
public class ConfidenceCalculatorReporter extends
	...
	/**
	 * Constructor for a new ConfidenceCalculatorReporter. Note that although
	 * any Reportable is accepted you should make sure that only subtypes of
	 * ConfidenceCalculator are passed to this constructor. Otherwise the number
	 * of column titles and their individual headings will differ from the
	 * actual content collected by this reporter.
	 * 
	 * @param informationSource
	 *            desmoj.core.simulator.Reportable : The ConfidenceCalculator to
	 *            report about.
	 */
