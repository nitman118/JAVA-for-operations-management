...
public interface Observer<T, X> {
	 ...
	 * 
	 * @param subject
	 *            Reference to the calling Subject
	 * @param eventObject
	 *            An eventtype to have the chance of Making branches for the different eventtypes
	 */
	public void update(T subject, X eventObject);
}