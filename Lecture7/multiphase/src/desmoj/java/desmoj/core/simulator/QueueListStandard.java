 ...
 * queueing strategies for a queue list. It provides all the basic methods
...
public abstract class QueueListStandard<E extends Entity> extends QueueList<E> implements PropertyChangeListener  {
	...
	/**
	 * Adds a new Entity to the QueueList. Entities are inserted according
	 ...
	 * specified order.
	 * 
	 * Do not forget to call the <code>statisticalInsert()</code> and
	 * to set the queue for each entity as you define this method.
	 * 
	 * @param e
	 *            Entity : The Entity to add to the QueueList
	 */
	 ...
	 * 			 was deleted or <code>false></code> if otherwise.
	 */
