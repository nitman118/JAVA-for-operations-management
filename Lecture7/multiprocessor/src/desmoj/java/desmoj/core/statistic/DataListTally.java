...
public class DataListTally extends Tally {
	...
	/**
	 * A simple List for storing values passed to a Tally. This list is created
	 * to produce low overhead while simulating.
	 */
	public class DataList extends Reportable {
		...
		public class Element {
			 ...
			 * 
			 * @param value
			 *            double : The value of this Element.
			 */
			 ...
			 * 
			 * @return the next Element in the list of <code>null</code> if this
			 *         is the last Element.
			 */
		 ...
		 * 
		 * @param owner
		 *            Model : The model this DataList is associated to
		 * @param name
		 *            java.lang.String : The name of this DataList object
		 * @param showInReport
		 *            boolean : Flag for showing the report about this DataList.
		 * @param showInTrace
		 ...
		 * 
		 * @param value
		 *            double : The value of the new Element in the list.
		 */
		...
		/**
		 * This Method is part of the sorting-algorithm. Cuts the first two
		 * Elements from the list and sort them.
		 * 
		 * @return A DataList containing the first two elements in a sorted
		 *         order.
		 */
		 ...
		 * 
		 * @param stack
		 *            DataList : A list to be merged with its predecessor on its
		 *            list-stack.
		 * 
		 * @return A merged DataList created from given DataList and its
		 *         predecessor on the list-stack.
		 */
		 ...
		 * 
		 * @param list
		 *            DataList : the list to be sorted.
		 * 
	...
	/**
	 * Updates this <code>DataListTally</code> object by fetching the actual
	...
	/**
	 * Updates this <code>DataListTally</code> object with the double value
	 * given as parameter. In some cases it might be more convenient to pass the
	 * value this <code>DataListTally</code> will be updated with directly
	 * within the <code>update(double val)</code> method instead of going via
	 * the <code>ValueSupplier</code>.
	 * 
	 * @param val
