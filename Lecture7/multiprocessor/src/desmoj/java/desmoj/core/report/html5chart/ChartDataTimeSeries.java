...
/**
 * A chart data for a Time Series.<br>
 * Data of a chart, which display a relationship between two variables from type <code>Double</code>.
 * 
...
public class ChartDataTimeSeries extends AbstractChartDataTable<Double> {
     ...
     */
    public ChartDataTimeSeries(Model ownerModel, List<Double> timeValues, List<Double> dataValues, Double validFrom, Double validTo, String group) {
