 ...
 * different standard variance values are assumed on both sides of the mode. <p> 
 * 
...
public class ContDistNormal extends ContDist {
	...
	/**
	 * Flag indicates whether there is already a calculated Gaussian value
    ...
    /**
     * Flag that indicates whether this distribution is asymmetric, i.e. using
	 ...
	 * normal (also known as "Gaussian") distribution. The specific 
	 * mean and standard deviation values have to be given here 
	 * at creation time.
	 * 
	 * @param owner
	 ...
	 * @param mean
	 *            double : The mean value of the normal distribution, equal to its mode
     ...
     * to the mode. Note that (different from the symmetric case) the
     * mean of this distribution is <i>not</i> equal to the mode; the mean of the
     * asymmetric distribution can be obtained by calling <code>getMean</code>. 
     * 
     * @param owner
     *            Model : The distribution's owner
     * @param name
     *            java.lang.String : The distribution's name
     * @param mode
     *            double : The mode value of the normal distribution
     * @param standardDeviationLeft
     *            double : The left standard deviation for this distribution
     * @param standardDeviationRight
     *            double : The right standard deviation for this distribution
     * @param showInReport
     *            boolean : Flag for producing reports
     * @param showInTrace
     *            boolean : Flag for producing trace output
    ...
    public ContDistNormal(Model owner, String name, double mode, double standardDeviationLeft, 
        ...
        symmetric = (standardDeviationLeft != standardDeviationRight) ? false : true;
    }
     ...
     * If this normal distribution is symmetric, this value is equal 
	 ...
	 * If this normal distribution is asymmetric, the left 
     ...
     * If this normal distribution is symmetric, this returns the same
     * as <code>getStdDevRight()</code>.
     * 
	 ...
	 * standard deviation values specified for this distribution. The basic
    ...
    public Double getInverseOfCumulativeProbabilityFunction(double p) {
        try {
            return new NormalDistributionImpl(this.getMean(), this.getStdDev()).inverseCumulativeProbability(p);
