...
/**
 * A simple class representing filenames. This class is used in the experiment
 * starter to distinguish strings from filenames which are edited using a file
 * chooser widget.
 * 
...
public class Filename {
	 ...
	 * @param isDir
	 *            this flag indicates if the filename specifies a directory
	 */
