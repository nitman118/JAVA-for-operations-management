...
/**
 * Construct a tree with a root that has each experiment as a child. Each
 * experiment has the URLs for the outputfiles as children. By selecting a leaf
 * in the tree the coresponding URL will be opened.
 * 
...
public class URLTreePanel extends JPanel {
	 ...
	 * 
	 * @param nodeText
	 *            String: text of node to create
	 * @param dir
	 *            String: directory with simulation output belonging to this
	 *            experiment
	 * @param appendixes
	 *            String[]: file type for debug, trace, error and report file
	 *            (e.g. .xml)
	 */
	...
	/**
	 * the call of this method lets the reportStylerPanel update its current
	 * display and provides the necessary values for it.
	 */
