 ...
 * transpoters or cranes and retrieved by transporters or cranes. The storing is
 * possible using <code>store()</code> of the Block. With the
 * <code>retrieve()</code> a container can be retrieved from the Block. A
 * Block is a part of the container <code>Yard</code>. There are no queues
...
public class Block extends Reportable {
	...
	/**
	 * The number of TEUs that are aready occupied and are avalaible for the
	 * retrieving.
	 */
	...
	/**
	 * Weighted sum of available TEUs in the Block over the time (must be
	 * divided by the total time to get the average available TEUs!)
	 */
	...
	/**
	 * Te conatiner typ of this block: the typ of the containers that can be
	 * stored/retrieved from this block. 0-empty, 1- normal, 2-reefer,
	 * 4-overlarge, 5- danger containers
	 */
	protected int ctyp;
	 ...
	 * 
	 * @param owner
	 *            desmoj.Model : The model this Block is associated to.
	 * @param name
	 *            java.lang.String : The Block's name.
	 * @param typ
	 ...
	 * @param capacity
	 *            long : The maximum capacity (TEU) of this Block.
	 * @param showInReport
	 *            boolean : Flag, if this Block should produce a report or not.
	 * @param showInTrace
	...
	public Block(Model owner, String name, int typ, long capacity,
		...
		if (capacity < 0) {
			...
			capacity = java.lang.Math.abs(capacity);
		}
	 ...
	 *            and export containers.
	 * @param capacity
	 *            long : The maximum capacity of this Block.
	 * @param init
	 ...
	 * container). When the capacity of the block can not hold the additional
	 * incoming TEUs the try to store will be refused.
	 * 
	 * @return boolean : Is <code>true</code> if the container can been stored
	 ...
	 * 
	 * @return double : The average number of TEUs available in the Block over
	 *         the time since the last reset of the Block.
	 */
	public double avgCapacity() {
		...
		double wSumAvl = wSumAvail
				+ ((double) currentCapacity * (now.getTimeValue() - lastUsage
						.getTimeValue()));
	...
	protected void updateStatistics() {
		...
		this.wSumAvail = this.wSumAvail
				+ ((double) this.currentCapacity * (now.getTimeValue() - lastUsage
						.getTimeValue()));
	 ...
	 * container). When the block is empty the try to retrieve will be refused.
	 * 
	 * @return boolean : Is <code>true</code> if the container can been stored
	 *         successfully, <code>false</code> otherwise.
	 * @param n
	 ...
	 * for a container) to be retrieved there later. When all the containers are
	 * already planed for the later retrieving the try to plan will be refused.
	 * 
	 * @return boolean : Is <code>true</code> if a container can been planed
	 *         successfully, <code>false</code> otherwise.
	 * @param n
	 *            long : The number of TEUs that a container that is in the
	 *            Block weights. n must be positive.
	 */
	...
	/**
	 * To reset the statistics of this Block. The current capacity and the
	 * number of avalaible TEUs for the storing and retrieving, reserving and
	 * planing are not changed. But all statistic counters are reset. The
	 ...
	 * place for a container) to be stored there later. When the whole available
	 * capacity is already reserved the try to reserve will be refused.
	 * 
	 * @return boolean : Is <code>true</code> if a place for a container can
	 *         been reserved successfully, <code>false</code> otherwise.
	 * @param n
	 *            long : The number of TEUs that are needed for a container to
	 *            be stored in the Block. n must be positive.
	 */
	 ...
	 * 
	 * @param ho
	 *            <code>HoldingArea</code>: The new holding area of this
	 *            Block.
	 */
	 ...
	 * 
	 * @param ctyp
	 *            int : The new container typ of this Block.
	 */
