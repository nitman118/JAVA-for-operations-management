...
public class BerthReporter extends Reporter {
	...
	/**
	 * Constructor for a new BerthReporter. Note that although any Reportable is
	 * accepted you should make sure that only subtypes of Yard are passed to
	 ...
	 *            desmoj.Reportable : The berth to report about
	 */
	...
	public String[] getEntries() {
		...
		if (source instanceof desmoj.extensions.applicationDomains.harbour.Berth) {
			...
			desmoj.extensions.applicationDomains.harbour.Berth b = (desmoj.extensions.applicationDomains.harbour.Berth) source; // source
			// =
			// informationSource
