 ...
 * normally modeled as some kind of <code>SimProcess</code> es. So what
 * happens at the TransportJunction is some kind of Rendez-vous synchronisation,
 * where <code>Transporter</code> s meet the goods to carry them around. There
 * is one wait queue for the masters (<code>Transporter</code>s) and one
 * queue for the slaves (<code>SimProcess</code> es), where they have to wait
 * for each other to cooperate. The <code>Transporter</code> s are the masters
 * which perform the transportation. The corporate transportation process is
 * described in the method <code>cooperation</code> in a subclass of
 ...
 * thereafter. The main difference to a normal <code>WaitQueue</code> is, that
 * in this case one master (<code>Transporter</code>) can cooperate with
 ...
 * flag to <code>true</code> to make it possible for transporters with a low
...
public class TransportJunction extends WaitQueue {
	...
	/**
	 * Flag to indicate whether a transporter can pass by other transporters in
	 * the master queue which are enqueued before that transporter in the queue.
	 ...
	 * 
	 * @param owner
	 *            desmoj.Model : The model this TransportJunction is associated
	 *            to.
	 * @param name
	 *            java.lang.String : The name of this TransportJunction.
	 * @param mSortOrder
	 ...
	 *            processes can be enqueued. Zero (0) means unlimited capacity.
	 * @param showInReport
	 *            boolean : Flag, if TransportJunction should produce a report
	 *            or not.
	 * @param showInTrace
	 *            boolean : Flag, if trace messages of this TransportJunction
	 ...
	 *            to.
	 * @param name
	 *            java.lang.String : The TransportJunction's name
	 * @param showInReport
	 *            boolean : Flag, if TransportJunction should produce a report
	 *            or not.
	 * @param showInTrace
	...
	/**
	 * This method is inherited from the class <code>WaitQueue</code> and will
	 ...
	 *            Transportation : The transportation process transportation is
	 ...
	 * transporters can pass by other transporters which are enqueued before
	 * them in the queue.
	 * 
	 * @param newPassBy
	 ...
	 * passive and will be reactivated after the transportation is done.
	 * 
	 * @return boolean : Is <code>true</code> if the process can be enqueued
	 *         successfully, <code>false</code> otherwise (i.e. capacity limit
	 *         of the master queue is reached).
	 ...
	 *            user in the class: <code>Transportation</code> in the
	 *            method: <code>transport()</code>.
	 */
	public boolean transport(Transportation transportation) {
		...
		if (currntProc instanceof desmoj.extensions.applicationDomains.production.Transporter) {
	...
	/**
	 * This method is to be called from a <code>Transporter</code> who wants
	 ...
	 *         of the master queue is reached).
	 * @param transportation
	 *            Transportation : The transportation process is describing the
	 ...
	 *         destination, <code>false</code> otherwise (i.e. capacity limit
