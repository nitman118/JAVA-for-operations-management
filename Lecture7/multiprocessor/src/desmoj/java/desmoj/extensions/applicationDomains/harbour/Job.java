...
/**
 * A Job represents any kind of job that the <code>InternalTransporter</code>
...
public class Job extends Entity {
	...
	/**
	 * Constructs a Job that must been done by an internal transporter. A Job
	 * has a certain typ. This typ must be 1 (import) or 0 (export), if the job
	 * is an import or export job. A Job has also certain origin and
	 * destination.
	 * 
	 * @param owner
	 *            desmoj.Model : The model this Job is associated to.
	 * @param name
	 *            java.lang.String : The name of this Job.
	 * @param typ
	 *            int : The typ of this Job: 1 or 0.
	 * @param origin
	 *            <code>ModelComponent</code>: The origin of this Job
	 * @param destination
	 *            <code>ModelComponent</code>: The destination of this Job
	 * @param showInTrace
	 *            boolean : Flag, if this Job should produce a trace output or
	 *            not.
	 */
	 ...
	 * 
	 * @param o
	 *            <code>ModelComponent</code>: The new origin of this Job.
	 */
	 ...
	 * 
	 * @param d
	 *            <code>ModelComponent</code>: The new destination of this
	 *            Job.
	 */
	 ...
	 * 
	 * @param b
	 *            boolean : The new flag if the job' been already selected.
	 */
