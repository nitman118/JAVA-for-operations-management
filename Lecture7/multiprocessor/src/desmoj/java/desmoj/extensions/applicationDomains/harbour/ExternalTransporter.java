...
public abstract class ExternalTransporter extends SimProcess {
	 ...
	 * to deliver and/or pick up some containers (goods). Implement its or more
	 * its derived classes <code>lifeCycle()</code> method like
	 ...
	 * terminal. Both must not be negative. Their default value is one.
	 * 
	 * @param owner
	 *            desmoj.Model : The model this ExternalTransporter is
	 *            associated to.
	 * @param name
	 *            java.lang.String : The name of this ExternalTransporter.
	 * @param nImportGoods
	 *            long : The number of import goods this ExternalTransporter has
	 *            to bring /take to/from container terminal.
	 * @param nExportGoods
	 *            long : The number of export goods this ExternalTransporter has
	 *            to take /bring from/to container terminal.
	 * @param showInTrace
	 ...
	 * to a new value. The new value must not be negative.
	 * 
	 * @param n
