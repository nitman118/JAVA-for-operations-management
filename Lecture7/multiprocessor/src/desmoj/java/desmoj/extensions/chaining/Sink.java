...
/**
 * The Sink represents the end of a production line and has no successor. The
 * Sink inherits all behavior from the Station except the transport time.
 * 
 * @param <E>
 *            The Entitiy which can be handled by the Sink
 *            
...
public class Sink<E extends Entity> extends Station<E> implements
	 ...
	 * sink assumes that there is no restriction. This applies to
	 ...
	 * @param recoveryTime
	 *            the time the station needs to recover
	 * @param owner
	 *            the model owner
	 * @param name
