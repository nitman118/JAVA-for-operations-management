...
public class CashRegisterModel extends Model{
	...
	ProcessQueue<Cassier> cassierQueue;
	...
	public void init() {
		...
		cassierQueue = new ProcessQueue<Cassier>(this, "CassierQueue", true, true);
	}

	public void doInitialSchedules() {
		for (int i = 0; i < 3; i++){
			Cassier cassier = new Cassier(this, "Cassier" + i, true);
			cassierQueue.insert(cassier);
		}
