...
public class CashRegisterModel extends Model{
	...
	ProcessQueue<Customer> queue1;
	Cassier cassier1;

	ProcessQueue<Customer> queue2;
	Cassier cassier2;
	...
	public void init() {
		...
		interarrivalTime = new ContDistExponential(this, "CustomerArrivalTimeStream", 10.0, true, false);
		interarrivalTime.setNonNegative(true);

		queue1 = new ProcessQueue<Customer>(this, "Queue1", true, true);
		queue2 = new ProcessQueue<Customer>(this, "Queue2", true, true);
	}

	public void doInitialSchedules() {
		cassier1 = new Cassier(this, "Cassier1", true, queue1);		
		
		cassier2 = new Cassier(this, "Cassier2", true, queue2);		
