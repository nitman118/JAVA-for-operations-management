...
/**
 * The ServiceStation represents a standard operating station which can process entities. It has exacty the same behaviour like the Station but can be
 * used in the modelling process due to no abstract modifier. This construct has its right to exist to have the possibility to implement further
 * behaviour or extensions.
 * 
 * @param <E>
 *            The Entitiy which is passed through the ServiceStation
 *            
...
public class ServiceStation<E extends Entity> extends Station<E> implements HasPredecessor<E>,
	 ...
	 * station assumes that there is no resriction. This applies to incomingBufferQueueCapacity, maxEntitiesToHandle, parallelHandledEntities
	 * 
	 ...
	 */
	private SuccessorAdministration<E> successorAdministration;
