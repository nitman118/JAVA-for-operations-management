 ...
 * 
 * @param <EIn>
 *            the entity which comes in the Transformer
 * @param <EEx>
...
public abstract class Merger<EIn extends Entity, EEx extends Entity> extends Station<EIn> implements
	 ...
	 * lower than zero the station assumes that there is no restriction. This applies to incomingBufferQueueCapacity, maxEntitiesToHandle,
	 ...
	 * cannot be found this method searches for superclasses of the entity. This gives the possibility to use a for instance a Tire class queue for
	 * RedTires classes
	 * 
	...
	/**
	 * This Method has to be overridden by the user and creates the outgoing entity. The user has the possibility to use the incomming entities of the
	 * Merger to define the new entity
	 * 
	 * @param parts
	 ...
	 */
	private SuccessorAdministration<EEx> successorAdministration;
