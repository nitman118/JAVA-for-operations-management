 ...
 * @param <P>
 */
public class QueueAnimation<P extends EntityAnimation> 
	extends Queue<P> implements ListInterface{
	...
	public QueueAnimation(ModelAnimation owner, String name, 
			boolean showInReport, boolean showInTrace) {
		this(owner, name, ProcessQueue.FIFO, Integer.MAX_VALUE, 
				showInReport, showInTrace);
	}

	public QueueAnimation(ModelAnimation owner, String name, int sortOrder, 
