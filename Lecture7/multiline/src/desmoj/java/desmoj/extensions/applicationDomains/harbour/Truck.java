...
/**
 * A Truck is an <code>ExternalTransporter</code> which arrives at a container
 ...
 * ExternalTrasnporter. Its <code>lifeCycle()</code> must be implemented by
 * the user in order to specify the behavior of the Truck.
 * 
...
public abstract class Truck extends ExternalTransporter {
	...
	/**
	 * the lane of the Truck where he waits at he holding area for an internal
	 * transporter to get unloaded/loaded.
	 */
	private Lane lane = null;

	/**
	 * Constructs a Truck which arrives at a container terminal to deliver
	 * and/or pick up some containers (goods). Implement its
	 ...
	 * a container terminal with.
	 * 
	 * @param owner
	 *            desmoj.Model : The model this Truck is associated to.
	 * @param name
	 *            java.lang.String : The name of this Truck.
	 * @param nImportGoods
	 ...
	 *            container terminal.
	 * @param speed
	 *            double : The speed of this Truck.
	 * @param showInTrace
	...
	/**
	 * Sets the speed of this Truck it drives with. to a new value. The new
	 * value must not be negative or zero.
	 * 
	 * @param s
	 *            double : The new speed of this Truck.
	 */
	 ...
	 * In this simple case only the time it takes to drive the distance with his
	 * speed. The time of drives of this Truck were counted in this method.
	 * 
	 * @param distance
	...
	public void drive(double distance) {
		...
		SimTime t = new SimTime(distance / this.speed);
		...
		this.driveTime = this.driveTime + t.getTimeValue();
	}
	 ...
	 * 
	 * @param l
	 *            <code>Lane</code>: The new lane of this Truck.
	 */
