...
public class CranesSystem extends QueueBased {
	...
	/**
	 * Counter for the whole number of the unloaded units of all the cranes of
	 * this CranesSystems.
	 */
	protected long sumNumUnloadedUnits;

	/**
	 * Counter for the whole time that all the cranes of this CranesSystems
	 * needed for the loading of the transporters.
	 */
	protected double sumLoadTime;

	/**
	 * Counter for the whole time that all the cranes of this CranesSystems
	 * needed for the unloading of the transporters.
	 */
	...
	/**
	 * Constructor for a CranesSystem. The queueing discipline and the capacity
	 * limit of the underlying queues for the cranes and for the transporters
	 * can be chosen.
	 * 
	 * @param owner
	 *            Model : The model this CranesSystem is associated to.
	 * @param name
	 *            java.lang.String : The CranesSystem's name
	 * @param csortOrder
	 ...
	 *            must be added to the old value.
	 */
	...
	/**
	 * Resets all statistical counters to their default values. Both, cranes
	 * queue and transporter queue are reset. The mininum and maximum length of
	 * the queues are set to the current number of queued objects.
	 */
	public void reset() {
	 ...
	 * 
	 * @param t
	 *            <code>SimProcess</code>: The transporter that me be
	 *            enqueued.
	 */
	...
	public double avgUsage() {
		...
		double result = (this.getSumLoadTime() + this.getSumUnloadTime())
				/ (this.cranesQueue.getQueueLimit() * now.getTimeValue());
		return result;
	}
