 ...
 * transpoters or cranes and retrieved by transporters or cranes. The yard
 * consists of blocks. The storing in the Yard is possible using
 ...
 * which provides the functionality of the Block.
 * 
 * @see Block
 * 
...
public class Yard extends Block {
	...
	/**
	 * The value for the yard overflow: place where the containers can be stored
	 * if the yard is full.
	 */
	 ...
	 * 
	 * @param owner
	 *            desmoj.Model : The model this Yard is associated to.
	 * @param name
	 *            java.lang.String : The Yard's name.
	 * @param typ
	...
	/**
	 * Method for producers to make the Yard add a block. This is only allowed
	 * as long as the Yard has not been used or the Yard has just been reset.
	 * 
	 * @param b
	 *            Block : The Block that must be added to this yard.
	 */
	 ...
	 *            int : The typ of the blocks.
	 * @param b
	 *            Block[] : The array of the certain blocks of the yard.
	 * @return <code>Block[]</code>: The Blocks of the yard of a certain typ.
	 */
	 ...
	 *            overflow part of this yard. n must be positive.
	 */
	...
	/**
	 * Method for producers to make the Yard store a number of n TEUs (a
	 * container). When the capacity of the yard can not hold the additional
	 * incoming TEUs the try to store will be refused.
	 * 
	 * @param b
	 *            Block : The block of the yard to store.
	 * @param n
	 ...
	 * container). When the yard is empty the try to retrieve will be refused.
	 * 
	 * @return boolean : Is <code>true</code> if the container can been stored
	 *         successfully, <code>false</code> otherwise.
	 * @param b
	 *            Block : The block of the yard to retrieve.
	 * @param n
	 *            long : The weight of the container to be stored in this Yard.
	 *            n must be positive.
	 */
	 ...
	 * for a container) to be stored there later. When the whole available
	 * capacity is already reserved the try to reserve will be refused.
	 * 
	 * @param b
	 *            Block : The block of the yard to reserve.
	 * @param n
	 *            long : The number of TEUs that are needed for a container to
	 *            be stored in the Yard. n must be positive.
	 ...
	 * 
	 * @param b
	 *            Block : The block of the yard to plan.
	 * @param n
	 *            long : The number of TEUs that a container that is in the Yard
	 *            weights. n must be positive.
	 ...
	 * 
	 * @param s
	 *            ChooseBlockYardStrategy : The new yard strategy.
	 */
	...
	/**
	 * To reset the statistics of this Yard. The statistics of all yard blocks
	 * will be reset too.
	 */
	public void reset() {
	 ...
	 * 
	 * @param ho
	 *            <code>HoldingArea</code>: The holding area that the blocks
	 *            are assigned to.
	 ...
	 * 
	 * @param ctyp
	 *            int : The typ of the contaners of this block.
	 * @return <code>Block[]</code>: The Blocks of the yard of a certain
	 *         container typ.
	 */
	 ...
	 *            containers in the blocks of the yard.
