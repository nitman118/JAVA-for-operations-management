...
public class AccumulateAnimation extends Accumulate{
	 ...
	 * @param name					name of Accumulate object
	 * @param showInReport			as in Accumulate
	 * @param showInTrace			as in Accumulate
	 */
	public AccumulateAnimation(ModelAnimation owner, String name, 
	...
	public void createAnimation(TimeInstant highTime, double valMin, double valMax, 
			int histogramCells, Position pos, Form form, 
		...
		if(this.showInAnimation){
			try {
				...
				c.setRemark(this.getGeneratedBy(AccumulateAnimation.class.getSimpleName()));
