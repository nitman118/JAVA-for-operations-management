...
public class BinGrafic extends JPanel implements Grafic{
	...
	private JScrollPane 	consumerPane;
	private JPanel 			consumerFlow, consumerPanel;
	private JPanel			stockPanel;
	private JLabel 			consumerLength;
	 ...
	 * @return 	smallest rectangle when an BinGrafic exist,
	 * 			null otherwise.
	 */
	...
	public BinGrafic(Bin bin, String viewId, Point pointExtern, 
		...
		if(bin.getName() != null) 	this.code = this.bin.getName();
		else 							this.code = "id: "+this.bin.getId();
	...
	private void updateStockPanel(){
		...
		this.stockLwb.setText("LWB: "+Long.toString(bin.getLwb()));
