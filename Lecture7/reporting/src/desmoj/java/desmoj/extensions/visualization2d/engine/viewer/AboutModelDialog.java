...
public class AboutModelDialog extends HelpDialogTemplate{
	...
	protected void buildDialog() throws MalformedURLException{
		if(model.isValid()){
			...
			if(projectName == null) projectName = "Simulation Project";
	...
	private Box getProjectBox(JDialog dialog) throws MalformedURLException{
		...
		URL	projectURL 			= null;
		try{
			if(projectURLString != null) projectURL = new URL(projectURLString);
		}catch(MalformedURLException e){ projectURL = null;}
