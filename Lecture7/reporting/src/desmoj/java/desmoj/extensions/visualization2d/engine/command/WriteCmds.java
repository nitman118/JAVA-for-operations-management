...
public abstract class WriteCmds {
	...
	/**
	 * Opens cmds-file and log-file and 
	 * organize the animation.model.Model instance (singelton)
	 * @param cmdFileName
	 * @param logFileName
	 */
	...
	public void write(Command c){
		...
		if(seqLength > this.flushSeq) this.flush(); 
	}
	...
	/**
	 * checks a command c by syntax (c.syntaxCheck) 
	 * and by semantic (c.execute()). Also a log-file is written.
