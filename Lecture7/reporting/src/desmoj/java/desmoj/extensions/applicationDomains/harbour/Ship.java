...
/**
 * A Ship is an <code>ExternalTransporter</code> wich arrives in a container
...
public abstract class Ship extends ExternalTransporter {
	...
	/**
	 * The number of cranes (containerbridges) that the ship needs fpr its
	 * complete unloading and/or loading.
	 */
	private int nCranes;
	 ...
	 * pick up some containers (goods). Implement its <code>lifeCycle()</code>
	 ...
	 * 
	 * @param owner
	 *            desmoj.Model : The model this Ship is associated to.
	 * @param name
	 *            java.lang.String : The name of this Ship.
	 * @param nImportGoods
	 ...
	 *            needs for its complete unloading and /or loading.
	 * @param showInTrace
	 ...
	 * 
	 * @param l
	 *            int : The new needed length of the berth for this Ship.
	 */
	 ...
	 * /or loading to a new value. The new value must not be negative or zero.
	 * 
	 * @param n
