...
public class TransporterSystem extends QueueBased {
	...
	/**
	 * The queue, actually storing the transporter processes waiting for jobs to
	 * do them.
	 */
	protected ProcessQueue transporterQueue;

	/**
	 * The queue, actually storing the jobs entities waiting to be assigned to
	 * the transporters.
	 */
	protected Queue jobsQueue;

	/**
	 * Counter for the whole number of the empty drives of all the transporters
	 * of this TransporterSystems.
	 */
	protected long SumNumEmptyDrives;

	/**
	 * Counter for the whole number of the loaded drives of all the transporters
	 * of this TransporterSystems.
	 */
	protected long SumNumLoadedDrives;

	/**
	 * Counter for the whole time of the empty drives of all the transporters of
	 * this TransporterSystems.
	 */
	protected double SumTimeEmptyDrives;

	/**
	 * Counter for the whole time of the loaded drives of all the transporters
	 * of this TransporterSystems.
	 */
	protected double SumTimeLoadedDrives;

	/**
	 * Counter for the whole distance of the empty drives of all the
	 * transporters of this TransporterSystems.
	 */
	protected double SumDistanceEmptyDrives = 0.0;

	/**
	 * Counter for the whole distance of the loaded drives of all the
	 * transporters of this TransporterSystems.
	 */
	...
	/**
	 * Constructor for a TransporterSystem. The queueing discipline and the
	 * capacity limit of the underlying queues for the jobs and for the
	 * transporters can be chosen.
	 * 
	 * @param owner
	 *            Model : The model this TransporterSystem is associated to.
	 * @param name
	 *            java.lang.String : The TransporterSystem's name
	 * @param tsortOrder
	 ...
	 *            capacity.
	 * @param jsortOrder
	 *            int : determines the sort order of the underlying jobs queue
	 *            implementation. Choose a constant from <code>QueueBased</code>
	 *            like <code>QueueBased.FIFO</code> or
	 *            <code>QueueBased.LIFO</code> or ...
	 * @param jQCapacity
	 *            int : The capacity of the jobs queue, that is how many
	 *            transporters can be enqueued. Zero (0) means unlimited
	 *            capacity.
	 * @param showInReport
	 *            boolean : Flag, if this TransporterSystem should produce a
	 *            report or not.
	 * @param showInTrace
	 ...
	 * 
	 * @param t
	 *            <code>Job</code>: The Job that me be enqueued.
	 */
	 ...
	 * 
	 * @param t
	 *            <code>Job</code>: The InternalTransporter that must be
	 *            enqueued.
	 */
	...
	/**
	 * Resets all statistical counters to their default values. Both,
	 * transporter queue and job queue are reset. The mininum and maximum length
	 * of the queues are set to the current number of queued objects.
	 */
	public void reset() {
	 ...
	 * 
	 * @param n
	 *            long : The number of empty drives of this TransporterSystem
	 *            that must be added to the old value.
	 */
	 ...
	 * 
	 * @param t
	 *            double : The time of empty drives of this TransporterSystem
	 *            that must be added to the old value.
	 */
	 ...
	 * 
	 * @param d
	 *            double : The whole distance of the empty drives of this
	 *            TransporterSystem that must be added to the old value.
	 */
	 ...
	 * 
	 * @param d
	 *            double : The whole distance of the loaded drives of this
	 *            TransporterSystem that must be added to the old value.
	 */
	 ...
	 * 
	 * @param n
	 *            long : The number of loaded drives of this TransporterSystem
	 *            that must be added to the old value.
	 */
	 ...
	 * 
	 * @param t
	 *            double : The whole time of loaded drives of this
	 *            TransporterSystem that must be added to the old value.
	 */
	...
	public double avgUsage() {
		...
		double result = (this.getSumTimeLoadedDrives() + this
				...
				/ (this.transporterQueue.getQueueLimit() * now.getTimeValue());
		return result;
	}
	 ...
	 * 
	 * @param c
	 *            <code>Crane</code>: The crane that these transportes are
	 *            assigned to.
	 * @return <code>InternalTransporter</code>[] : The idle internal
