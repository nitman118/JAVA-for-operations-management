...
/**
 * A T_Control represents the control component for the transporters. The
 * transporters get the <code>Jobs</code> from this control that assignes the
 * job to them by using a certain <code>TransportStrategy</code>. Its
...
public class T_Control extends SimProcess {
	...
	/**
	 * The transport strategy that this transport control uses by the assigning
	 * jobs to the transporters.
	 */
	private TransportStrategy s = null;

	/**
	 * The transporter system that manages all the statistic of the all
	 * transporters of this transporter control.
	 */
	private TransporterSystem ts = null;

	/**
	 * Constructor for a transport control T_Control for the transporters. The
	 * queueing discipline and the capacity limit of the underlying queues for
	 * the jobs and for the transporters can be chosen.
	 * 
	 * @param owner
	 *            Model : The model this T_Control is associated to.
	 * @param name
	 *            java.lang.String : The T_Control's name
	 * @param tsortOrder
	 ...
	 * @param jQCapacity
	 *            int : The capacity of the jobs queue, that is how many jobs
	 *            can be enqueued. Zero (0) means unlimited capacity.
	 * @param s
	 *            TransportStrategy : The strategy that this T_Control uses to
	 *            assign the jobs to the transporters.
	 * @param showInReport
	 *            boolean : Flag, if T_Control (its TransporterSystem) should
	 *            produce a report or not.
	 * @param showInTrace
	 ...
	 * 
	 * @param t
	 *            <code>Job</code>: The Job that must be assigned to a
	 *            transporter.
	 */
	public void addJob(Job j) {
		...
		if (!this.isScheduled()) {
			...
			this.activateAfter(currentProcess);
		}
	}
	 ...
	 * 
	 * @param t
	 *            <code>InternalTranspoter</code>: The InternalTransporter
	 *            that is idle.
	 */
	public void addTransporter(InternalTransporter t) {
	...
	/**
	 * This method implements the transporter control specific behaviour. This
	 * behavior is always the same therefore there is no need to implement that
	 * in a subclass of T_Control. This method starts after a transporter
	 * control has been created and activated by the scheduler.
	 */
	 ...
	 * 
	 * @param ts
	 *            TransporterSystem : The new transport system of this
	 *            transporter control.
	 */
	 ...
	 * 
	 * @param s
	 *            TransportStrategy : The new transport strategy of this
	 *            transporter control.
	 */
