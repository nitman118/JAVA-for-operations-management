...
public class XMLReportOutput extends XMLOutput implements OutputType {
	...
	public void receive(Reporter r) {
		...
		// ###--- geaendert von Nick
		if (!(r instanceof desmoj.core.report.TableReporter))
		...
		else if (r instanceof desmoj.core.report.HistogramReporter) {
		...
		else if (r instanceof desmoj.core.advancedModellingFeatures.report.StockReporter) {
		...
		else if (r instanceof desmoj.core.report.TableReporter) {
