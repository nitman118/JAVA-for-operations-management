 ...
 * value of type Double. This "distribution" is most useful for testing purposes. The
...
public class ContDistConstant extends ContDist {
	 ...
	 * @param constantValue
	 *            double : The constant value produced by this distribution
	 * @param showInReport
	 ...
	 * 
	 * @param newValue
	 *            double : the new value to be returned by this pseudo
	 *            distribution
	 */
	 ...
	 * makes no sense to set a <code>ConstantDiscreteDist</code> object with a
	 * negative constant to nonNegative. In this case a warning will be sent. <br>
