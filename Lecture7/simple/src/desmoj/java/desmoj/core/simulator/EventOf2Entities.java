 ...
 * For events changing the state of <b>one</b> or <b>three</b> entities,
 * refer to <code>Event</code> and <code>EventOf3Entities</code>.
...
public abstract class EventOf2Entities<E extends Entity, F extends Entity> extends EventAbstract {
	...
	public void schedule(E who1, F who2, TimeInstant instant) {
        ...
        // schedule Event
		getModel().getExperiment().getScheduler().schedule(who1, who2, this, instant);
    ...
    public void schedule(E who1, F who2, NumericalDist<?> dist) {
        ...
        // generate trace
        this.generateTraceForScheduling(who1, who2, null, null, null, TimeOperations.add(presentTime(), dt), " Sampled from " + dist.getQuotedName() + ".");
	...
	public void scheduleAfter(Schedulable after, E who1, F who2) {
        ...
        // generate trace
        this.generateTraceForScheduling(who1, who2, null, after, null, after.getEventNotes().get(after.getEventNotes().size()-1).getTime(), null);
