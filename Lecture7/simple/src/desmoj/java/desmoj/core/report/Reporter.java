...
public abstract class Reporter {
     ...
     * This Schedulable must have a corresponding Reportable assigned via
     * <code>setCorrespondingReportable(Reportable)</code>. 
     * 
     * @param Schedulable
     *            desmoj.core.simulator.Schedulable : The Schedulable to report about
     */
    ...
    /**
     * Creates a reporter, preliminarily without information source. Internal framework use only,
     * intended for refinement in subclasses.
     */
    protected Reporter() {
