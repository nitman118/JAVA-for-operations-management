...
public class DataListHistogramReporter extends Reporter {
	/**
	 * Defines the maximal amount of classes found by the algorithm to calculate
	 * the histogram's dimensions.
	 */
	...
	/**
	 * The histogram's dimensions, containing the lowest value, the greatest
	 * value, the interval-size and the count of elements in the histogram.
	 */
	private double[] _dimensions;

	/**
	 * Constructor for a new DataListReporter. Note that although any Reportable
	 * is accepted you should make sure that only subtypes of
	 * DataListTally.DataList are passed to this constructor. Otherwise an
	 ...
	 *            about.
	 * @param min
	 *            double : The DataList's minimal value.
	 * @param max
	 *            double : The DataList's maximal value.
	 */
	...
	/**
	 * Calculates the histogram's dimensions, containing the lowest value, the
	 * greatest value, the interval-size and the count of elements in the
	 * histogram.
	 * 
	 * @param min
	 * 		double : The list's minimal value.
	 * @param max
	 * 		double : The list's maximal value.
