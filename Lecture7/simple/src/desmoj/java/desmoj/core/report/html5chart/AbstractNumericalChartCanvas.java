 ...
 */
public abstract class AbstractNumericalChartCanvas<N extends Number> extends NamedObject implements CanvasCoordinateChart<N> {
	...
	public AbstractNumericalChartCanvas(String canvasID, int canvasHeight, int canvasWidth) {
		...
		if (canvasHeight > 270) _canvasHeight = canvasHeight;
		else _canvasHeight = 270;
		
		if (canvasWidth > 400) _canvasWidth = canvasWidth;
		else _canvasWidth = 400;		
	}
