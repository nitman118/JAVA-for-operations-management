 ...
 * Worker is derived from SimProcess. Its <code>lifeCycle()</code> must be
 * implemented by the user in order to specify the behavior of the Worker.
 * 
 * @see SimProcess
 * @see Processing
 * @see WorkStation
...
public abstract class Worker extends SimProcess {
	 ...
	 * 
	 * @param owner
	 *            desmoj.Model : The model this Worker is associated to.
	 * @param name
	 *            java.lang.String : The name of this Worker.
	 * @param showInTrace
	 *            boolean : Flag, if trace messages of this Worker should be
	 *            displayed in the trace file or not.
	 */
	 ...
	 * specific behaviour. It should contain at least something to let this
	 * Worker wait in a <code>WorkStation</code> for parts to process them,
	 * like <br>
	 * <code> WorkStationXY.cooperate(processing);</code><br>
	 * This <code>lifeCycle()</code> method starts after a Worker has been
	 ...
	 * Worker (as a master) acts together with other <code>SimProcess</code>
