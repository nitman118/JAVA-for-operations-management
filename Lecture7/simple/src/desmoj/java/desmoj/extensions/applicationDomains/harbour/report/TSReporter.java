...
public class TSReporter extends StockReporter {
	...
	/**
	 * The column headings of the queues (transporter and jobs) part of this
	 * TransporterSystemReporter. Entries should contain the elements in the
	 * same order as the <code>tsEntries[]</code>.
	 */
	private String tsColumns[];

	/**
	 * The data entries of the queues (transporter and jobs) part of this
	 * TransporterSystemReporter. The entries should contain the data elements
	 * in the same order as defined in the <code>tsColumns[]</code> array.
	 */
	private String tsEntries[];

	/**
	 * The number of columns of the queues (transporter and jobs) part of this
	 * TransporterSystemReporter.
	 */
	private int tsNumColumns;

	/**
	 * Constructor for a new TSReporter. Note that although any Reportable is
	 * accepted you should make sure that only subtypes of TransporterSystem are
	 * passed to this constructor. Otherwise the number of column titles and
	 * their individual headings will differ from the actual content collected
	 * by this reporter.
	 * 
	 * @param informationSource
	 *            desmoj.Reportable : The TransporterSystem to report about
	 */
	...
	public String[] getEntries() {
		...
		if (source instanceof desmoj.extensions.applicationDomains.harbour.TransporterSystem) {
			...
			// informationsource)
			desmoj.extensions.applicationDomains.harbour.TransporterSystem ts = (desmoj.extensions.applicationDomains.harbour.TransporterSystem) source;
	 ...
	 *         queues part of this TSReporter.
	 */
