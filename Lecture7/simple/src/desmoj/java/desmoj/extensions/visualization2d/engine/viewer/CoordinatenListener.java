 ...
 * Der Listener wertet MouseEvents aus und beim Click auf Button2
 *   wird in viewerPanel der ZoomCenterPoint gesetzt.
 * 
...
public class CoordinatenListener implements MouseListener, MouseMotionListener{
	...
	/**
	 * wertet MouseEvent e aus und schreibt die Cursor Position 
	 * in die Statuszeile des ViewerPanel.
	 * @param e
	 */
