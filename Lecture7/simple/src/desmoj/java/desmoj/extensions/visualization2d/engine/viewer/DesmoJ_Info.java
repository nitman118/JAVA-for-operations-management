 ...
 * Bei der Initialisierung werden diese Daten aus desmoj.core.simulator.Experiment
 * bezogen, falls diese Klasse bekannt ist. 
 * Zusaetzlich sind diese Daten auch in dem cmds-File enthalten. 
 * Auf diese Daten wird mit update zugegriffen.
 * Dieser Weg wird beschritten, da desmoj.extensions.visualization2d.engine
 * auch unabhaengig vom Rest-System funktionsfaehig sein soll, 
 * z.B. als Viewer-Applet.
 * 
...
public class DesmoJ_Info {
	...
	/**
	 * Falls desmoj.core.simulator.Experiment bekannt ist,
	 * werden die Methoden getDesmoJVersion und getDesmoJLicense ausgelesen.
	 * Dieser Weg wird beschritten, da desmoj.extensions.visualization2d.engine
	 * auch unabhaengig vom Rest-System funktionsfaehig sein soll, 
	 * z.B. als Viewer-Applet.
	 */
