 ...
 * run. An ExperimentRunListener can register with an ExperimentRunner and
 * becomes notified when the assigned simulation experiment is (Re)started,
 * paused or finally stopped.
 * 
