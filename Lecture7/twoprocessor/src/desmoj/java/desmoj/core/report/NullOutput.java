 ...
 * simmply ignoring all received messaged and reporters. It also doesn't create
 * any system resource. 
 * This implementation can be used if you want to suppress creation of default file(s)
