...
public abstract class ValueStatistics extends
     ...
     * 
     * @param ownerModel
     *            Model : The model this ValueStatistics is associated to
     * @param name
     *            java.lang.String : The name of this ValueStatistics object
     * @param valSup
     *            ValueSupplier : The ValueSupplier providing the value for this
     *            ValueStatistics. The given ValueSupplier will be observed by
     *            this ValueStatistics object.
     * @param showInReport
    ...
    /**
     * Returns the standard deviation of all the values observed so far. Has to
    ...
    /**
     * Updates this <code>ValueStatistics</code> object by fetching the actual
    ...
    /**
     * Updates this <code>ValueStatistics</code> object with the double value
     * given as parameter. In some cases it might be more convenient to pass the
     * value this <code>ValueStatistics</code> will be updated with directly
