...
public class Stock implements Basic {
	...
	private Hashtable<String, Long>		consumerProducts;
	private	List						producer;
	private Hashtable<String, Long>		producerProducts;
	private long						count; 
	private long						upb;
	private long						lwb;
	...
	public Stock(Model model, String id, long capacity, long initialValue){
		...
		if(this.id != null) model.getStocks().add(this);
	}
	...
	public Grafic createGrafic(String viewId, int x, int y, String defaultEntityTypeId, 
		...
		this.grafic =  new StockGrafic(this, viewId, new Point(x, y), defaultEntityTypeId, anzVisible, horizontal, deltaSize);
		return this.grafic;
	}
