...
public class EntrepotReporter extends desmoj.core.report.Reporter {
	...
	/**
	 * Constructor for a new EntrepotReporter. Note that although any Reportable
	 * is accepted you should make sure that only subtypes of Entrepot are
	 ...
	 *            desmoj.Reportable : The Entrepot to report about
	 */
	...
	public String[] getEntries() {
		if (source instanceof desmoj.extensions.applicationDomains.production.Entrepot) {
			...
			desmoj.extensions.applicationDomains.production.Entrepot e = (desmoj.extensions.applicationDomains.production.Entrepot) source; // source
			// =
			// informationSource
