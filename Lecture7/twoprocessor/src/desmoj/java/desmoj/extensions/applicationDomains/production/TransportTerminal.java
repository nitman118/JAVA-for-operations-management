 ...
 * around. The <code>SimpleTransporter</code> s are generated automatically
 ...
 * when he wants to model transportation in his model.
 * 
...
public class TransportTerminal extends ModelComponent {
	 ...
	 * associated to. From there they start and to that
	 * <code>TransportJunction</code> they return.
	 */
	private TransportJunction homeTerminal;

	/**
	 * The <code>Transportation</code> the transporters are performing. That
	 * is the joint cooperation of one transporter and the goods (
	 ...
	 * for the transporters and the goods can be chosen, too.
	 * 
	 * @param owner
	 *            desmoj.Model : The model this TransportTerminal is associated
	 *            to.
	 * @param name
	 *            java.lang.String : The name of this TransportTerminal.
	 * @param numOfTransp
	 ...
	 * Constructor for a simple TransportTerminal where a given number of
	 * <code>SimpleTransporter</code> s wait for goods to carry them to their
	 * destination. The <code>SimpleTransporter</code> s all have a minimum
	...
	/**
	 * Returns the underlying <code>TransportJunction</code>. That is the
	 * home base of all the transporters associated to this TransportTerminal.
	 * 
	 * @return desmoj.TransportJunction : The home base of the transporters
	 *         associated to this TransportTerminal.
	 */
	 ...
	 * 
	 * @return boolean : Is <code>true</code> if the transporter can be
	 *         enqueued successfully, <code>false</code> otherwise (i.e.
	 *         capacity limit of the transporter queue is reached).
	 * @param transport
	 ...
	 */
	public boolean transport(Transportation transport) {
	 ...
	 * method is passed on to the underlying <code>TransportJunction</code>.
	 * 
	 * @return boolean : Is <code>true</code> if the transporter can be
	 *         enqueued successfully, <code>false</code> otherwise (i.e.
	 *         capacity limit of the master queue is reached).
	 * @param transport
	 *            Transportation : The transportation process transport is
	 *            describing the joint action of the processes. The transport to
	 *            be carried out has to be implemented by the user in the class:
	 ...
	 *            <code>Condition</code> in the method: <code>check()</code>.
	 */
	public boolean transport(Transportation transport, Condition cond) {
		// call the same method from the TransportJunction home terminal
